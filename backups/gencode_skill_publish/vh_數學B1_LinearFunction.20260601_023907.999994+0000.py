...
VERIFIED_CANDIDATE_MODULES = {'integer_numeric_evaluate_function_notation': 'generated_candidates/vocational_math_b1/section_1_2/integer_numeric_evaluate_function_notation/candidate_v1.py'}
