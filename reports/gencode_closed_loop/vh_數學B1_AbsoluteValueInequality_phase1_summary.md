...
```json
{
  ...
  "timestamp": "2026-05-28T01:40:27.971801+00:00",
  "dry_run": true,
  "auto_review_summary": {
    "skill_id": "vh_數學B1_AbsoluteValueInequality",
    "candidate_problem_types": [
...
| source_index | 題號/標題 | example_id | source_type | matched_problem_type_id | checker | equivalence | reason | question_preview |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
