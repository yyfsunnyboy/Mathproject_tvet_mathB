# Gencode Phase1 Summary: vh_數學B1_PropertiesOfParallelLines
...
- skill_ch_name: `兩平行線的性質`
- expected_task_families: []
- expected_subskill_candidates: []
- skill_anchor_scope: `default`
- observed_source_family_distribution: {'distance_between_two_points_family': 2, 'generic_numeric_family': 2}
- observed_target_task_distribution: {'compute_distance_between_two_points': 2, 'contextual_application': 2}
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 4530 | compute_distance_between_two_points | distance_between_two_points_family | unclassified_low_confidence | False | False | unclassified_low_confidence | 設$A\left( 2,0 \right)$、$B\left( -3,5 \right)$、$C\left( -1,-1 |
| 4535 | compute_distance_between_two_points | distance_between_two_points_family | unclassified_low_confidence | False | False | unclassified_low_confidence | 設$A\left( 1,-5 \right)$、$B\left( 4,1 \right)$、$C\left( -1,x  |
| 4600 | contextual_application | generic_numeric_family | unclassified_low_confidence | False | False | unclassified_low_confidence | 已知平面上四點$A\left( 1,3 \right)$、$B\left( 2,5 \right)$、$C\left(  |
| 4602 | contextual_application | generic_numeric_family | unclassified_low_confidence | False | False | unclassified_low_confidence | 平面上過兩點$\left( 1,3 \right)$、$\left( 3,5 \right)$的直線和過另兩點$\lef |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 4530 |  |  | 0.0 | compute_distance_between_two_points | distance_between_two_points_family | compute_distance_between_two_points | distance_between_two_points_family | rule_fallback_ai_unavailable | ai_api_key_missing | True |
| 4535 |  |  | 0.0 | compute_distance_between_two_points | distance_between_two_points_family | compute_distance_between_two_points | distance_between_two_points_family | rule_fallback_ai_unavailable | ai_api_key_missing | True |
| 4600 |  |  | 0.0 | compute_numeric | generic_numeric_family | compute_numeric | generic_numeric_family | rule_fallback_ai_unavailable | ai_api_key_missing | True |
| 4602 |  |  | 0.0 | compute_numeric | generic_numeric_family | compute_numeric | generic_numeric_family | rule_fallback_ai_unavailable | ai_api_key_missing | True |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 4530 | compute_distance_between_two_points/distance_between_two_points_family | / | 0.0 | clause45_unclassified_exception | compute_distance_between_two_points/distance_between_two_points_family | unclassified_low_confidence | unclassified_low_confidence |
| 4535 | compute_distance_between_two_points/distance_between_two_points_family | / | 0.0 | clause45_unclassified_exception | compute_distance_between_two_points/distance_between_two_points_family | unclassified_low_confidence | unclassified_low_confidence |
| 4600 | compute_numeric/generic_numeric_family | / | 0.0 | clause45_unclassified_exception | contextual_application/generic_numeric_family | unclassified_low_confidence | unclassified_low_confidence |
| 4602 | compute_numeric/generic_numeric_family | / | 0.0 | clause45_unclassified_exception | contextual_application/generic_numeric_family | unclassified_low_confidence | unclassified_low_confidence |


## Same-section family distribution

{'distance_between_two_points_family': 2, 'generic_numeric_family': 2}

## Example features

| example_id | answer_type | target_task | has_choices | stem_embeds_choices | math_objects |
| --- | --- | --- | --- | --- | --- |
| 4530 | text_short | compute_distance_between_two_points | False | False | coordinate_point, distance_formula, segment_length, three_coordinate_points, triangle, two_coordinate_points |
| 4535 | text_short | compute_distance_between_two_points | False | False | coordinate_point, distance_formula, segment_length, three_coordinate_points, triangle, two_coordinate_points |
| 4600 | choice | contextual_application | True | True | coordinate_point, three_coordinate_points, triangle, two_coordinate_points |
| 4602 | choice | contextual_application | True | True | coordinate_point, three_coordinate_points, triangle, two_coordinate_points |

## Induction clusters

### Cluster 1
- answer_type: `short_answer`
- source_example_ids: [4530, 4535]
- grouping_reason: single_signature_group
- feature_signature: `['short_answer', 'compute_distance_between_two_points', 'short_answer', ('distance_formula_reasoning',), ('coordinate_point', 'distance_formula')]`

### Cluster 2
- answer_type: `single_choice`
- source_example_ids: [4600, 4602]
- grouping_reason: single_signature_group
- feature_signature: `['single_choice', 'contextual_application', 'single_choice', ('numeric_computation',), ('coordinate_point', 'three_coordinate_points')]`
...
| --- | --- | --- | --- | --- |
| text_short_compute_distance_between_two_points | text_short / compute_distance_between_two_points | expression | [4530, 4535] | single_signature_group |
| choice_contextual_application | choice / contextual_application | choice | [4600, 4602] | single_signature_group |
...
```json
{
  ...
  "main_skill_anchor": {
    "skill_id": "vh_數學B1_PropertiesOfParallelLines",
    "skill_ch_name": "兩平行線的性質",
    "skill_en_name": "PropertiesOfParallelLines",
    "chapter": "2 直線方程式",
    "section": "2-1 斜率",
    ...
    "source_skill_id": "vh_數學B1_PropertiesOfParallelLines",
  ...
  "semantic_alignment": {
    ...
    "observed_target_task_distribution": {
      "compute_distance_between_two_points": 2,
      "contextual_application": 2
    },
    ...
    "observed_source_family_distribution": {
      "distance_between_two_points_family": 2,
    ...
    "uniform_core_target_task": "compute_distance_between_two_points",
    ...
    "classification_scope": "within_current_skill",
    "skill_mapping_authority": "textbook_examples.skill_id",
    "core_skill_concept": "propertiesofparallellines",
  ...
  "clause45_proxy_problem_type_ids": [
    "fallback_compute_distance_between_two_points",
  ...
  "source_example_alignment": [
    {
      ...
      "skill_id": "vh_數學B1_PropertiesOfParallelLines",
      "title_stem_preview": "設$A\\left( 2,0 \\right)$、$B\\left( -3,5 \\right)$、$C\\left( -1,-1 \\right)$、$D\\left( 4"
    },
    {
      "example_id": 4535,
      "target_task": "compute_distance_between_two_points",
      ...
      "induction_eligibility": "excluded",
      "skill_id": "vh_數學B1_PropertiesOfParallelLines",
      "title_stem_preview": "設$A\\left( 1,-5 \\right)$、$B\\left( 4,1 \\right)$、$C\\left( -1,x \\right)$、$D\\left( -4"
    },
    {
      "example_id": 4600,
      "target_task": "contextual_application",
      ...
      "induction_eligibility": "excluded",
      "skill_id": "vh_數學B1_PropertiesOfParallelLines",
      "title_stem_preview": "已知平面上四點$A\\left( 1,3 \\right)$、$B\\left( 2,5 \\right)$、$C\\left( 3,1 \\right)$、$D\\left"
    },
    {
      "example_id": 4602,
      "target_task": "contextual_application",
      ...
      "induction_eligibility": "excluded",
      "skill_id": "vh_數學B1_PropertiesOfParallelLines",
      "title_stem_preview": "平面上過兩點$\\left( 1,3 \\right)$、$\\left( 3,5 \\right)$的直線和過另兩點$\\left( 2,0 \\right)$、$\\le"
    }
  ],
  ...
  "answer_contract_summary": {
    ...
    "observed_problem_type_answer_contracts": {
      "fallback_compute_distance_between_two_points_2": {
  ...
  "timestamp": "2026-06-14T14:24:14.771987+00:00",
  "dry_run": true,
  "auto_review_summary": {
    "skill_id": "vh_數學B1_PropertiesOfParallelLines",
    "main_skill_anchor": {
    ...
    "candidate_problem_types": [
      {
        "problem_type_id": "fallback_compute_distance_between_two_points_2",
        "proposed_problem_type_id": "fallback_compute_distance_between_two_points_2",
        "display_name": "兩點距離計算",
        "matched_example_ids": [
          4530,
          4535
      ...
      {
        "problem_type_id": "skill_scoped_unresolved_problem_type_2",
        "proposed_problem_type_id": "skill_scoped_unresolved_problem_type_2",
        "display_name": "single_choice / contextual_application",
        "matched_example_ids": [
          4600,
          4602
