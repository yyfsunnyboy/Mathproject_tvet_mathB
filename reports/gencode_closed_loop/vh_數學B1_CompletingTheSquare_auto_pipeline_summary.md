# Gencode Auto Pipeline Summary: vh_數學B1_CompletingTheSquare
...
```json
{
  ...
  "per_example_classification": [
    {
      ...
      "example_feature": {
        ...
        "question_text": "利用配方法將下列各式化為$a{{\\left( x+m \\right)}^{2}}+n$的形式。\n(1)${{x}^{2}}-6x$ (2)$4{{x}^{2}}-16x+3$",
        "answer": "",
        "choices": [],
        "has_choices": false,
    ...
    {
      "example_id": 4501,
      "detected_problem_type_id": "fallback_choose_correct_statement",
      "example_feature": {
        "source_example_id": 4501,
        "question_text": "試判斷拋物線$y=3{{x}^{2}}+2x+4$的頂點落在哪一象限？ (A)第一象限 (B)第二象限 (C)第三象限 (D)第四象限。",
        "answer": "A",
        "choices": [
          "第一象限",
          "第二象限",
        ...
        "semantic_classification": {
          ...
          "skill_scoped_candidates": [
            ...
            },
            {
              ...
              "target_task": "choose_correct_statement",
              "task_family": "classify_quadrant_family",
              "problem_type_id": "choose_correct_statement",
              "label": "choose_correct_statement",
              "candidate_source": "outsider",
              "in_anchor_scope": false,
              "answer_type": "numeric",
              "answer_shape": "numeric",
        ...
        "enrichment_reasons": [],
        "included_in_core_induction": true,
        "problem_type_id": "fallback_choose_correct_statement",
        "proxy_problem_type_id": "fallback_choose_correct_statement",
        "equivalence_type": "choice_label",
        "checker_key": "choice_label_checker",
        "requires_human_action": false
      },
  ...
  "reports": {
    "auto_pipeline_summary_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_auto_pipeline_summary.json",
    "auto_pipeline_summary_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_auto_pipeline_summary.md",
    "phase1_summary_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase1_summary.json",
    "phase1_summary_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase1_summary.md",
    "phase1_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase1_summary.json",
    "phase1_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase1_summary.md",
    ...
    "phase2_generator_summary_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase2_generator_summary.md",
    "phase2_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase2_generator_summary.json",
    "phase2_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_CompletingTheSquare_phase2_generator_summary.md",
  ...
  "timestamp": "2026-06-13T13:37:12.255938+00:00",
  "dry_run": true
}
```
