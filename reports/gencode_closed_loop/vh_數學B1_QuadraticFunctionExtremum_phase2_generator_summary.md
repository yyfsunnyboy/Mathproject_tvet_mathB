# Gencode Phase2 Generator Summary: vh_數學B1_QuadraticFunctionExtremum
...
```json
{
  ...
  "generator_results": [
    {
      ...
      "answer_contract": {
        ...
        "generator_contract": {
          ...
          "template_slots": {
            "stem": "quadratic_vertex_extremum_rational"
          },
      ...
      "diversity_sampling": {
        ...
        "diversity_blockers": [
          "answer_format_mismatch:payload_not_following_answer_format_hint",
    ...
    },
    {
      ...
      "answer_contract": {
        ...
        "generator_contract": {
          ...
          "problem_type_id": "compute_quadratic_vertex_single_choice",
          "contract_validation_blockers": [],
          "contract_validation_warnings": [
            "single_template_variant_only",
            "variation_dimensions_below_recommended_minimum"
  ...
  "failed_generators": [
    "vh_數學B1_QuadraticFunctionExtremum:integer_compute_quadratic_vertex:draft_v1",
    "vh_數學B1_QuadraticFunctionExtremum:single_choice_quadratic_standard_to_vertex_properties_single_choice:draft_v1"
  ],
  "accepted_generators": [
    "vh_數學B1_QuadraticFunctionExtremum:integer_quadratic_vertex_or_parameter_computation:draft_v1",
    "vh_數學B1_QuadraticFunctionExtremum:integer_compute_quadratic_vertex:draft_v1",
    "vh_數學B1_QuadraticFunctionExtremum:text_short_quadratic_vertex_or_parameter_computation:draft_v1"
  ],
  ...
  "reports": {
    ...
    "phase2_generator_summary_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticFunctionExtremum_phase2_generator_summary.md",
    "phase2_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticFunctionExtremum_phase2_generator_summary.json",
    "phase2_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticFunctionExtremum_phase2_generator_summary.md",
  ...
  "next_action": "phase3_package_draft",
  "timestamp": "2026-06-13T15:24:48.457106+00:00",
  "dry_run": true
}
```
