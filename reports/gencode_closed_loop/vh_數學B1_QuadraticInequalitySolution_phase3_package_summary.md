# Gencode Phase3 Package Summary: vh_數學B1_QuadraticInequalitySolution
...
```json
{
  ...
  "skill_file_path": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\drafts\\vh_數學B1_QuadraticInequalitySolution.py",
  ...
  "runtime_smoke_raw": {
    ...
    "payload_preview": {
      ...
      "answer_contract_answer_type": "interval",
      "checker": "interval_checker",
      "equivalence": "interval_equivalence",
      "question_text_len": 74,
      "answer": "x<1 or x>5",
    ...
    "validation_diagnostics": {
      ...
      "checker": "interval_checker",
      "equivalence": "interval_equivalence",
      "answer_repr": "'x<1 or x>5'",
      "answer_python_type": "str",
      "correct_answer_repr": "'x<1 or x>5'",
      ...
      "expected_answer_shape": "interval allows interval string or supported interval object/list; answer_shape=interval_or_union",
  ...
  "packaging_diagnostics": {
    ...
    "runtime_spec_alignment": {
      ...
      "synced_problem_type_ids": [
        "integer_reverse_quadratic_inequality_coefficients",
        "integer_solve_quadratic_inequality",
        "rational_solve_quadratic_inequality",
        "integer_applied_quadratic_inequality_problem",
        "integer_solve_quadratic_inequality_parameter_range",
        "rational_solve_quadratic_inequality_special_cases",
        "text_short_factor_quadratic_by_cross_multiplication"
      ],
      "induced_spec_path": "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_QuadraticInequalitySolution.json",
      "purged_induced_spec_path": "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_QuadraticInequalitySolution.json",
      "purged_induced_spec_paths": [
        "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_QuadraticInequalitySolution.json"
      ],
      ...
      "downgraded_historical_problem_type_ids": [
        "interval_applied_quadratic_inequality_problem_single_choice",
        "interval_solve_quadratic_inequality_expression",
        "interval_solve_quadratic_inequality_single_choice"
      ],
      "canonical_filter_applied": true
    }
  },
  "reports": {
    "phase3_package_summary_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalitySolution_phase3_package_summary.json",
    "phase3_package_summary_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalitySolution_phase3_package_summary.md",
    "phase3_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalitySolution_phase3_package_summary.json",
    "phase3_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalitySolution_phase3_package_summary.md",
    "final_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalitySolution_phase3_package_summary.json",
    "final_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalitySolution_phase3_package_summary.md",
    "draft_skill_file": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\drafts\\vh_數學B1_QuadraticInequalitySolution.py"
  },
  "next_action": "review_phase3_publish_check",
  "error": "",
  "dry_run": true,
  "timestamp": "2026-06-14T05:19:54.113261+00:00",
  ...
  "source_alignment_audit": {
    ...
    "missing_source_aligned_problem_types": [
      ...
      "numeric_applied_quadratic_inequality_problem_single_choice",
      "numeric_reverse_quadratic_inequality_coefficients_short_answer",
      "numeric_solve_quadratic_inequality_parameter_range_short_answer",
      "numeric_solve_quadratic_inequality_short_answer",
      "numeric_solve_quadratic_inequality_single_choice",
      "numeric_solve_quadratic_inequality_special_cases_single_choice",
      "short_answer_factor_quadratic_by_cross_multiplication_short_answer"
    ],
