...
```json
{
  ...
  "packaging_diagnostics": {
    ...
    "excluded": [
      {
        ...
        "reasons": [
          "slot_base_task_mismatch:factor_quadratic_by_cross_multiplication!=function_value_numeric"
        ]
      },
      {
        ...
        "reasons": [
          "slot_base_task_mismatch:factor_quadratic_by_cross_multiplication!=linear_function_two_point_choice"
        ]
      }
    ],
    ...
    "runtime_spec_alignment": {
      ...
      "purged_induced_spec_path": "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_CartesianCoordinateSystemEstablishment.json",
      "purged_induced_spec_paths": [
        "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_CartesianCoordinateSystemEstablishment.json"
      ],
  ...
  "error": "",
  "dry_run": true,
  "timestamp": "2026-07-01T04:37:46.990264+00:00",
  ...
  "source_alignment_audit": {
    ...
    "missing_source_aligned_problem_types": [
      "short_answer_classify_quadrant_short_answer",
      "short_answer_compute_numeric_short_answer",
      "single_choice_choose_correct_statement_single_choice",
      "single_choice_compute_distance_between_two_points_single_choice"
    ],
  ...
  "summary_message": "Phase 3 blocked: no usable generators for packaging (candidates=2, included=0).\n  - evaluate_function_value: slot_base_task_mismatch:factor_quadratic_by_cross_multiplication!=function_value_numeric\n  - interpret_function_notation: slot_base_task_mismatch:factor_quadratic_by_cross_multiplication!=linear_function_two_point_choice",
