# Gencode Phase1 Summary: vh_數學B1_QuadraticInequalityAndFactoring
...
- **Report Contract Warnings**: ['per_example_alignment_score_corrected:4473', 'per_example_alignment_score_corrected:4480', 'per_example_alignment_score_corrected:4490', 'candidate_problem_type_count_synchronized']
...
- skill_ch_name: `一元二次不等式的基本概念與十字交乘法`
- expected_task_families: ['quadratic_inequality_family']
- expected_subskill_candidates: ['factor_quadratic_by_cross_multiplication', 'interpret_quadratic_inequality_solution_set', 'solve_quadratic_by_factoring', 'solve_quadratic_inequality']
- skill_anchor_scope: `default`
- observed_source_family_distribution: {'quadratic_inequality_family': 3}
- observed_target_task_distribution: {'factor_quadratic_by_cross_multiplication': 3}
...
- alignment_score: `0.8`
- alignment_blockers: []
- alignment_warnings: ['ai_first_mode_fell_back_to_rule_only', 'uniform_core_target_task_alignment_threshold_relaxed']

| example_id | target_task | task_family | alignment_kind | subskill_match | included | exclude_reason | stem_preview |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 4473 | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | anchor_subskill_match | True | True |  | 利用十字交乘法分解下列各式：
(1)${{x}^{2}}-2x-15$ (2)$2{{x}^{2}}+9x-5$ (3) |
| 4480 | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | anchor_subskill_match | True | True |  | 利用十字交乘法分解下列各式：
(1)${{x}^{2}}-6x+8$ (2)$2{{x}^{2}}-5x+2$ (3)$ |
| 4490 | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | anchor_subskill_match | True | True |  | 利用十字交乘法分解下列各式：
(1)${{x}^{2}}-6x-16$ (2)$3{{x}^{2}}-5x-2$ (3) |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 4473 |  |  | 0.45 | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | rule_fallback_ai_unavailable | ai_api_key_missing | False |
| 4480 |  |  | 0.45 | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | rule_fallback_ai_unavailable | ai_api_key_missing | False |
| 4490 |  |  | 0.45 | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | factor_quadratic_by_cross_multiplication | quadratic_inequality_family | rule_fallback_ai_unavailable | ai_api_key_missing | False |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 4473 | factor_quadratic_by_cross_multiplication/quadratic_inequality_family | / | 0.45 | rule_fallback_ai_unavailable | factor_quadratic_by_cross_multiplication/quadratic_inequality_family | anchor_subskill_match |  |
| 4480 | factor_quadratic_by_cross_multiplication/quadratic_inequality_family | / | 0.45 | rule_fallback_ai_unavailable | factor_quadratic_by_cross_multiplication/quadratic_inequality_family | anchor_subskill_match |  |
| 4490 | factor_quadratic_by_cross_multiplication/quadratic_inequality_family | / | 0.45 | rule_fallback_ai_unavailable | factor_quadratic_by_cross_multiplication/quadratic_inequality_family | anchor_subskill_match |  |


## Same-section family distribution

{'quadratic_inequality_family': 3}

## Example features

| example_id | answer_type | target_task | has_choices | stem_embeds_choices | math_objects |
| --- | --- | --- | --- | --- | --- |
| 4473 | integer | factor_quadratic_by_cross_multiplication | False | False | factoring_expression, quadratic_equation, quadratic_trinomial |
| 4480 | integer | factor_quadratic_by_cross_multiplication | False | False | factoring_expression, quadratic_equation, quadratic_trinomial |
| 4490 | integer | factor_quadratic_by_cross_multiplication | False | False | factoring_expression, quadratic_equation, quadratic_trinomial |

## Induction clusters

### Cluster 1
- answer_type: `numeric`
- source_example_ids: [4473, 4480, 4490]
- grouping_reason: single_signature_group
- feature_signature: `['numeric', 'factor_quadratic_by_cross_multiplication', 'short_answer', ('quadratic_factoring_reasoning',), ('factoring_expression', 'quadratic_equation')]`
...
| --- | --- | --- | --- | --- |
| integer_factor_quadratic_by_cross_multiplication | integer / factor_quadratic_by_cross_multiplication | choice | [4473, 4480, 4490] | single_signature_group |
...
```json
{
  ...
  "main_skill_anchor": {
    "skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
    "skill_ch_name": "一元二次不等式的基本概念與十字交乘法",
    "skill_en_name": "QuadraticInequalityAndFactoring",
    "chapter": "1 坐標系與函數圖形",
    "section": "1-4 一元二次不等式",
    ...
    "fallback_subskill": {
      ...
      "subskill_name": "一元二次不等式的基本概念與十字交乘法",
    ...
    "source_skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
  ...
  "semantic_alignment": {
    ...
    "observed_target_task_distribution": {
      "factor_quadratic_by_cross_multiplication": 3
    },
    ...
    "problem_type_terms": [
      ...
      "multiplication",
      "numeric",
      "numeric / factor_quadratic_by_cross_multiplication",
      "quadratic",
    ...
    "dominant_source_task": "factor_quadratic_by_cross_multiplication",
    "dominant_source_task_ratio": 1.0,
    "uniform_core_target_task": "factor_quadratic_by_cross_multiplication",
    "uniform_core_target_task_ratio": 1.0,
    "uniform_core_target_task_count": 3,
    ...
    "per_problem_type_scores": [
      {
        "problem_type_id": "numeric_factor_quadratic_by_cross_multiplication_short_answer",
        "target_task": "factor_quadratic_by_cross_multiplication",
        "task_family": "quadratic_inequality_family",
        "inferred_tasks": [
          "factor_quadratic_by_cross_multiplication"
        ],
        "skill_problem_type_score": 0.0312,
        "source_problem_type_score": 0.069,
    ...
    "induction_core_example_count": 3,
    "induction_enrichment_example_count": 0,
    "source_skill_scope_locked": true,
    "source_skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
    "classification_scope": "within_current_skill",
    "skill_mapping_authority": "textbook_examples.skill_id",
    "core_skill_concept": "quadraticinequalityandfactoring",
  ...
  "semantic_classifications": [
    {
      ...
      "failed_stage": "",
      "rule_target_task": "factor_quadratic_by_cross_multiplication",
      "rule_task_family": "quadratic_inequality_family",
      "rule_confidence": 0.72,
      "final_target_task": "factor_quadratic_by_cross_multiplication",
      ...
      "skill_scoped_candidates": [
        {
          ...
          "target_task": "factor_quadratic_by_cross_multiplication",
          "task_family": "quadratic_inequality_family",
          "problem_type_id": "factor_quadratic_by_cross_multiplication",
          "label": "factor_quadratic_by_cross_multiplication",
        ...
        {
          "candidate_id": "C2",
          "target_task": "interpret_quadratic_inequality_solution_set",
          "task_family": "quadratic_inequality_family",
          "problem_type_id": "interpret_quadratic_inequality_solution_set",
          "label": "interpret_quadratic_inequality_solution_set",
          "candidate_source": "anchor",
          "in_anchor_scope": true,
          "answer_type": "numeric",
          "answer_shape": "numeric",
        ...
        {
          "candidate_id": "C3",
          "target_task": "solve_quadratic_by_factoring",
          "task_family": "quadratic_inequality_family",
          "problem_type_id": "solve_quadratic_by_factoring",
          "label": "solve_quadratic_by_factoring",
          "candidate_source": "anchor",
          "in_anchor_scope": true,
          "answer_type": "numeric",
          "answer_shape": "numeric",
        ...
        },
        {
          ...
          "task_family": "quadratic_inequality_family",
          "problem_type_id": "solve_quadratic_inequality",
          "label": "solve_quadratic_inequality",
          "candidate_source": "anchor",
          "in_anchor_scope": true,
          "answer_type": "numeric",
          "answer_shape": "numeric",
      ...
      "outsider_candidates": [],
      "selected_subskill": "factor_quadratic_by_cross_multiplication",
      "selected_problem_type": "factor_quadratic_by_cross_multiplication",
      "candidate_source": "anchor",
  ...
  "source_belongs_to_current_skill_by_default_count": 3,
  "source_example_alignment": [
    {
      ...
      "skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
      "title_stem_preview": "利用十字交乘法分解下列各式：\n(1)${{x}^{2}}-2x-15$ (2)$2{{x}^{2}}+9x-5$ (3)$6{{x}^{2}}+x-15$"
    },
    {
      "example_id": 4480,
      "target_task": "factor_quadratic_by_cross_multiplication",
      ...
      "induction_eligibility": "eligible",
      "skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
      "title_stem_preview": "利用十字交乘法分解下列各式：\n(1)${{x}^{2}}-6x+8$ (2)$2{{x}^{2}}-5x+2$ (3)$6{{x}^{2}}+x-12$"
    },
    {
      "example_id": 4490,
      "target_task": "factor_quadratic_by_cross_multiplication",
      ...
      "induction_eligibility": "eligible",
      "skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
      "title_stem_preview": "利用十字交乘法分解下列各式：\n(1)${{x}^{2}}-6x-16$ (2)$3{{x}^{2}}-5x-2$ (3)$12{{x}^{2}}+x-6$"
    }
  ],
  "candidate_problem_types": [
    {
      "problem_type_id": "integer_factor_quadratic_by_cross_multiplication",
      "proposed_problem_type_id": "integer_factor_quadratic_by_cross_multiplication",
      "display_name": "integer / factor_quadratic_by_cross_multiplication",
      "matched_example_ids": [
        4473,
        4480,
        4490
      ...
      "representative_example_id": 4473,
      "structural_features": [
        "single_choice"
      ],
      "answer_contract_proposal": {
        ...
        "generator_contract": {
          ...
          "template_slots": {
            "stem": "quadratic_graph_vertex_axis_choice"
          }
        },
        "validator_contract": {
          "static_checks": [
      ...
      "problem_type_spec_draft": {
        "problem_type_id": "choice_factor_quadratic_by_cross_multiplication_expression",
        "skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
        "target_task": "factor_quadratic_by_cross_multiplication",
        "task_family": "quadratic_inequality_family",
        "display_name": "numeric / factor_quadratic_by_cross_multiplication",
        "answer_format_hint": "",
        "answer_fields": null,
        ...
        "canonical_base_problem_type_id": "factor_quadratic_by_cross_multiplication_short_answer",
        "value_type_prefix": "numeric",
        "_resolved_template_slot": "quadratic_graph_vertex_axis_choice"
      },
      ...
      "canonical_base_problem_type_id": "factor_quadratic_by_cross_multiplication_short_answer",
      "value_type_prefix": "numeric",
      "subskill_id": "factor_quadratic_by_cross_multiplication",
  ...
  "per_example_classification": [
    {
      "example_id": 4473,
      "detected_problem_type_id": "numeric_factor_quadratic_by_cross_multiplication_short_answer",
      "example_feature": {
        "source_example_id": 4473,
        "question_text": "利用十字交乘法分解下列各式：\n(1)${{x}^{2}}-2x-15$ (2)$2{{x}^{2}}+9x-5$ (3)$6{{x}^{2}}+x-15$",
        "answer": "",
        "choices": [],
        "has_choices": false,
        ...
        "target": "factor_quadratic_by_cross_multiplication",
        "classifier_source": "rule_fallback_ai_unavailable",
  ...
  "reports": {
    "phase1_summary_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalityAndFactoring_phase1_summary.json",
    "phase1_summary_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalityAndFactoring_phase1_summary.md",
    "phase1_json": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalityAndFactoring_phase1_summary.json",
    "phase1_md": "E:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_QuadraticInequalityAndFactoring_phase1_summary.md"
  },
  "next_action": "phase2_generate_from_induced_specs",
  "timestamp": "2026-06-13T15:50:16.723844+00:00",
  "dry_run": true,
  "auto_review_summary": {
    "skill_id": "vh_數學B1_QuadraticInequalityAndFactoring",
    "main_skill_anchor": {
    ...
    "candidate_problem_types": [
      {
        "problem_type_id": "numeric_factor_quadratic_by_cross_multiplication_short_answer",
        "proposed_problem_type_id": "numeric_factor_quadratic_by_cross_multiplication_short_answer",
        "display_name": "numeric / factor_quadratic_by_cross_multiplication",
        "matched_example_ids": [
          4473,
          4480,
  ...
  "report_contract_warnings": [
    "per_example_alignment_score_corrected:4473",
    "per_example_alignment_score_corrected:4480",
    "per_example_alignment_score_corrected:4490",
