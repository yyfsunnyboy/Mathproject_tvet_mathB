...
- required_generators: perpendicular_lines_properties
- missing_generators: -
...
- discovered_candidates: perpendicular_lines_properties
- missing_candidate_files: -
- unsupported_candidate_problem_types: -
- verified_candidates: perpendicular_lines_properties
- failed_candidates: -
- sample_count: 11
...
- verified_problem_types: perpendicular_lines_properties
...
- command: python scripts\gencode_pipeline_phase3_publish_gate.py --skill-id vh_數學B1_PropertiesOfPerpendicularLines
