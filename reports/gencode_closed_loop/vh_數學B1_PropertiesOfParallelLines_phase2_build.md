...
- build_mode: normal
- input_phase1_report: E:\Python\Mathproject_tvet_mathB\reports\gencode_closed_loop\vh_數學B1_PropertiesOfParallelLines_phase1_audit.json
...
- required_generators: parallel_lines_properties
- missing_generators: -
...
- discovered_candidates: parallel_lines_properties
- missing_candidate_files: -
- unsupported_candidate_problem_types: -
- verified_candidates: parallel_lines_properties
- failed_candidates: -
- sample_count: 11
...
- verified_problem_types: parallel_lines_properties
...
- command: python scripts\gencode_pipeline_phase3_publish_gate.py --skill-id vh_數學B1_PropertiesOfParallelLines
