...
```json
{
  ...
  "generator_results": [
    {
      ...
      "checker_contract_blockers": [],
      "checker_contract_warnings": [],
      "generator_key": "vh_數學B1_LinearFunction:numeric_evaluate_function_value_short_answer:draft_v1",
  ...
  "failed_generators": [
    "vh_數學B1_LinearFunction:numeric_evaluate_function_value_short_answer:draft_v1"
  ],
  "accepted_generators": [],
  "reports": {
  ...
  "next_action": "review_blockers_before_phase3",
  "timestamp": "2026-05-30T16:02:23.909100+00:00",
  "dry_run": true
}
```
