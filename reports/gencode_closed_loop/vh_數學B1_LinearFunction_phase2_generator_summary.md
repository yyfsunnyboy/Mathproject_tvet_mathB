...
```json
{
  ...
  "generator_results": [
    {
      ...
      "answer_contract": {
        ...
        "checker_capability_status": "warn",
        ...
        "generator_contract": {
          ...
          "problem_type_id": "numeric_evaluate_function_value_short_answer",
      ...
      "checker_contract_blockers": [],
      "checker_contract_warnings": [],
      "generator_key": "vh_數學B1_LinearFunction:integer_evaluate_function_value:draft_v1",
    ...
    {
      "problem_type_id": "expression_interpret_function_notation",
      ...
      "checker_contract_blockers": [],
      "checker_contract_warnings": [],
      "generator_key": "vh_數學B1_LinearFunction:expression_interpret_function_notation:draft_v1",
      "generator_status": "runtime_ready_with_warning",
      "checker_smoke_status": "passed",
      "dynamic_sampling_status": "runtime_ready_with_diversity_warning",
      "diversity_sampling": {
    ...
    {
      "problem_type_id": "expression_evaluate_function_value",
      ...
      "checker_contract_blockers": [],
      "checker_contract_warnings": [],
      "generator_key": "vh_數學B1_LinearFunction:expression_evaluate_function_value:draft_v1",
      "generator_status": "runtime_ready_with_warning",
      "checker_smoke_status": "passed",
      "dynamic_sampling_status": "runtime_ready_with_diversity_warning",
      "diversity_sampling": {
    ...
    },
    {
      ...
      "answer_contract": {
        ...
        "generator_contract": {
          ...
          "problem_type_id": "single_choice_interpret_function_notation_single_choice",
          "contract_validation_blockers": [],
          "contract_validation_warnings": [
            "single_template_variant_only",
            "variation_dimensions_below_recommended_minimum"
  ...
  "failed_generators": [],
  "accepted_generators": [
    "vh_數學B1_LinearFunction:integer_evaluate_function_value:draft_v1",
    "vh_數學B1_LinearFunction:expression_interpret_function_notation:draft_v1",
    "vh_數學B1_LinearFunction:expression_evaluate_function_value:draft_v1",
    "vh_數學B1_LinearFunction:expression_interpret_function_notation:draft_v1"
  ],
  ...
  "reports": {
    ...
    "phase2_generator_summary_md": "D:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_LinearFunction_phase2_generator_summary.md",
    "phase2_json": "D:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_LinearFunction_phase2_generator_summary.json",
    "phase2_md": "D:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_LinearFunction_phase2_generator_summary.md",
  ...
  "next_action": "phase3_package_draft",
  "timestamp": "2026-06-01T08:25:52.993549+00:00",
  "dry_run": true
}
```
