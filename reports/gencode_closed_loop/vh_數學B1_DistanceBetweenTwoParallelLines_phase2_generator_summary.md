# Gencode Phase2 Generator Summary: vh_數學B1_DistanceBetweenTwoParallelLines
...
```json
{
  ...
  "generator_results": [
    ...
    },
    {
      ...
      "diversity_sampling": {
        ...
        "unique_question_text_count": 30,
        "template_variant_distribution": {
          "triangle_median_through_vertex": 9,
          "triangle_median_area_bisector": 13,
          "triangle_median_coordinate_plane": 8
        },
        "answer_shape_distribution": {
          "linear_equation": 30
        },
  ...
  "failed_generators": [],
  "accepted_generators": [
    "vh_數學B1_DistanceBetweenTwoParallelLines:equation_write_line_equation_from_point_slope_short_answer:draft_v1",
    "vh_數學B1_DistanceBetweenTwoParallelLines:equation_write_line_equation_from_slope_and_intercept_short_answer:draft_v1",
    "vh_數學B1_DistanceBetweenTwoParallelLines:equation_write_line_equation_from_two_points_short_answer:draft_v1",
    "vh_數學B1_DistanceBetweenTwoParallelLines:equation_write_perpendicular_bisector_from_two_points_short_answer:draft_v1",
    "vh_數學B1_DistanceBetweenTwoParallelLines:equation_write_triangle_median_line_from_vertices_short_answer:draft_v1"
  ],
  ...
  "reports": {
    ...
    "phase2_generator_summary_md": "D:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_DistanceBetweenTwoParallelLines_phase2_generator_summary.md",
    "phase2_json": "D:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_DistanceBetweenTwoParallelLines_phase2_generator_summary.json",
    "phase2_md": "D:\\Python\\Mathproject_tvet_mathB\\reports\\gencode_closed_loop\\vh_數學B1_DistanceBetweenTwoParallelLines_phase2_generator_summary.md",
  ...
  "next_action": "phase3_package_draft",
  "timestamp": "2026-06-22T07:01:27.081756+00:00",
  "dry_run": true
}
```
