...
```json
{
  ...
  "packaging_diagnostics": {
    ...
    "runtime_spec_alignment": {
      ...
      "synced_problem_type_ids": [
        "integer_evaluate_function_value",
        "expression_interpret_function_notation",
        "expression_evaluate_function_value"
      ],
      "induced_spec_path": "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_LinearFunction.json",
      "purged_induced_spec_path": "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_LinearFunction.json",
      "purged_induced_spec_paths": [
        "reports\\gencode_closed_loop\\induced_specs\\vh_數學B1_LinearFunction.json"
      ],
      ...
      "downgraded_historical_problem_type_ids": [
        "single_choice_interpret_function_notation_single_choice"
      ],
  ...
  "source_alignment_audit": {
    ...
    "missing_source_aligned_problem_types": [
      "numeric_evaluate_function_value_short_answer",
      "short_answer_evaluate_function_value_fallback_application",
      "short_answer_interpret_function_notation_short_answer",
      "single_choice_interpret_function_notation_single_choice"
    ],
