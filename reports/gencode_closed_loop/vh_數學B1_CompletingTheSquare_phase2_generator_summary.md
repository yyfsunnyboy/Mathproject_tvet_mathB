# Gencode Phase2 Generator Summary: vh_數學B1_CompletingTheSquare
...
```json
{
    ...
    },
    {
      ...
      "answer_contract": {
        ...
        "generator_contract": {
          ...
          "use_domain_functions": true,
          "derivation_steps_required": true,
          "problem_type_id": "quadratic_graph_vertex_axis_choice_single_choice",
          "contract_validation_blockers": [],
          "contract_validation_warnings": [
            "single_template_variant_only",
            "variation_dimensions_below_recommended_minimum"
  ...
  "failed_generators": [],
  "accepted_generators": [
    "vh_數學B1_CompletingTheSquare:integer_quadratic_vertex_or_parameter_computation:draft_v1",
    "vh_數學B1_CompletingTheSquare:integer_quadratic_graph_vertex_axis_choice:draft_v1"
  ],
  ...
  "next_action": "phase3_package_draft",
  "timestamp": "2026-06-13T13:48:08.910092+00:00",
  "dry_run": true
}
```
