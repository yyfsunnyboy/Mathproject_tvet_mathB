...
```json
{
  ...
  "packaging_diagnostics": {
    ...
    "included": [
      ...
      {
        "problem_type_id": "ordered_tuple_compute_centroid_coordinates",
        "generator_key": "vh_數學B1_MidpointCoordinates:ordered_tuple_compute_centroid_coordinates:draft_v1",
        "generator_status": "runtime_ready_with_warning"
      }
    ],
    "excluded": [
      {
        ...
        "generator_key": "vh_數學B1_MidpointCoordinates:single_choice_evaluate_function_value_fallback_application:draft_v1",
        "generator_status": "runtime_ready_with_warning",
        ...
        "reasons": [
          "slot_base_task_mismatch:point_quadrant_choice!=function_value_numeric"
        ]
      },
      {
        "problem_type_id": "interpret_function_notation",
        "generator_key": "vh_數學B1_MidpointCoordinates:interpret_function_notation:draft_v1",
        "generator_status": "runtime_ready_with_warning",
        "checker_smoke_status": "passed",
        "dynamic_sampling_status": "runtime_ready_with_diversity_warning",
        "blockers": [],
    ...
    "runtime_spec_alignment": {
      ...
      "synced_problem_type_ids": [
        ...
        "ordered_tuple_compute_centroid_coordinates"
      ],
  ...
  "error": "",
  "dry_run": true,
  "timestamp": "2026-07-03T16:25:26.302808+00:00",
