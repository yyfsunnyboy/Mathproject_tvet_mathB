...
- build_mode: normal
- input_phase1_report: D:\Python\Mathproject_tvet_mathB\reports\gencode_closed_loop\vh_數學B1_LinearFunction_phase1_audit.json
...
- required_generators: integer_numeric_evaluate_function_notation
- missing_generators: -
...
- discovered_candidates: integer_numeric_evaluate_function_notation
- missing_candidate_files: -
- unsupported_candidate_problem_types: -
- verified_candidates: integer_numeric_evaluate_function_notation
- failed_candidates: -
- sample_count: 11
...
- command: python scripts\gencode_pipeline_phase3_publish_gate.py --skill-id vh_數學B1_LinearFunction
