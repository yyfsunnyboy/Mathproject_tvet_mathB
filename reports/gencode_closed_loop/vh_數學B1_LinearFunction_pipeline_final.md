...
- verified problem types: integer_numeric_evaluate_function_notation
...
## 6. Runtime Coverage
- expected_problem_types: integer_numeric_evaluate_function_notation
- observed_problem_types: integer_numeric_evaluate_function_notation
