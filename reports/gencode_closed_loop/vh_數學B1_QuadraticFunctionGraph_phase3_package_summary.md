...
```json
{
  ...
  "runtime_smoke_raw": {
    ...
    "payload_preview": {
      ...
      "question_text_len": 55,
      "answer": "向右 3、向上 3",
      "correct_answer": "向右 3、向上 3",
      "choices_count": 0,
      "metadata_keys": [
        "givens",
        "target",
    ...
    "validation_diagnostics": {
      ...
      "checker": "text_short_checker",
      "equivalence": "exact_string",
      "answer_repr": "'向右 3、向上 3'",
      "answer_python_type": "str",
      "correct_answer_repr": "'向右 3、向上 3'",
  ...
  "error": "",
  "dry_run": true,
  "timestamp": "2026-06-13T05:06:27.686055+00:00",
  ...
  "source_alignment_audit": {
    ...
    "missing_source_aligned_problem_types": [
      "numeric_quadratic_graph_properties_choice_single_choice",
