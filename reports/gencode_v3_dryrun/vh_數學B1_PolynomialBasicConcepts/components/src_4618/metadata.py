...
COMPONENT_ID: Final[str] = "src_4618"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialBasicConcepts"
SOURCE_REF: Final[str] = "src_4618"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4618
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "complete_descriptive_statistics_table"
ANSWER_SCHEMA_KEY: Final[str] = "numeric_scalar"
LINE_TYPE: Final[str] = "complete_descriptive_statistics_table"

TARGET_TASK: Final[str] = "complete_descriptive_statistics_table"
TEMPLATE_SLOT: Final[str] = "complete_descriptive_statistics_table"
PROBLEM_TYPE_ID: Final[str] = "complete_descriptive_statistics_table"
