...
COMPONENT_ID: Final[str] = 'src_4476'
SKILL_ID: Final[str] = 'vh_數學B1_QuadraticInequalitySolution'
SOURCE_REF: Final[str] = 'src_4476'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4476
IS_REQUIRED_CORE: Final[bool] = False
ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'applied_quadratic_inequality_problem'
TARGET_TASK: Final[str] = 'applied_quadratic_inequality_problem'
TEMPLATE_SLOT: Final[str] = 'applied_quadratic_inequality_problem'
PROBLEM_TYPE_ID: Final[str] = 'integer_applied_quadratic_inequality_problem'
