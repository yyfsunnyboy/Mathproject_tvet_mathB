...
COMPONENT_ID: Final[str] = 'src_4487'
SKILL_ID: Final[str] = 'vh_數學B1_QuadraticInequalitySolution'
SOURCE_REF: Final[str] = 'src_4487'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4487
IS_REQUIRED_CORE: Final[bool] = False
ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'solve_quadratic_inequality_parameter_range'
TARGET_TASK: Final[str] = 'solve_quadratic_inequality_parameter_range'
TEMPLATE_SLOT: Final[str] = 'solve_quadratic_inequality_parameter_range'
PROBLEM_TYPE_ID: Final[str] = 'integer_solve_quadratic_inequality_parameter_range'
