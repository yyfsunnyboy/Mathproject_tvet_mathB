...
DOMAIN_OPERATION: Final[str] = "vertical_line"
ANSWER_SCHEMA_KEY: Final[str] = "line_equation"
LINE_TYPE: Final[str] = "vertical_line"

TARGET_TASK: Final[str] = "vertical_line"
TEMPLATE_SLOT: Final[str] = "vertical_line"
