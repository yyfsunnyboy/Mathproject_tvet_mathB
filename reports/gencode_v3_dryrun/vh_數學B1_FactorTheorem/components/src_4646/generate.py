...
TEXTBOOK_EXAMPLE_ID = 4646
DEFAULT_COMPONENT_ID = "src_4646" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "若x + 2是$f\\left( x \\right)=3{{x}^{3}}+5{{x}^{2}}+ax+2$之因式，試求a之值。"
