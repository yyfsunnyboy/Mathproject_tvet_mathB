...
def generate(level: int = 1, seed: int | None = None, **kwargs: Any) -> dict[str, Any]:
    matrix = build_line_equation_matrix(
        ...
        constraints={'v3_induced_spec': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_HorizontalAndVerticalLineEquations', 'source_example_id': 4544, 'textbook_example_id': 4544, 'source_hash': '2847e4e4c3400b8272539370e8d2bb29', 'problem_type_id': 'vertical_line', 'required_capabilities': ['vertical_line'], 'classification_source': 'deterministic', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'phase1_classification': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_HorizontalAndVerticalLineEquations', 'source_example_id': 4544, 'textbook_example_id': 4544, 'source_hash': '2847e4e4c3400b8272539370e8d2bb29', 'problem_type_id': 'vertical_line', 'required_capabilities': ['vertical_line'], 'classification_source': 'deterministic', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'classification_source': 'deterministic', 'source_example_id': 4544, 'source_hash': '2847e4e4c3400b8272539370e8d2bb29', 'problem_type_id': 'vertical_line', 'domain_operation': 'vertical_line', 'line_type': 'vertical_line', 'required_capabilities': ['vertical_line'], 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression', 'exact_task_operation': ''},
    )
