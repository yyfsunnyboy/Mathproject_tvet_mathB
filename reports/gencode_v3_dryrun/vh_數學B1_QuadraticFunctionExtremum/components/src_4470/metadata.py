...
COMPONENT_ID: Final[str] = 'src_4470'
SKILL_ID: Final[str] = 'vh_數學B1_QuadraticFunctionExtremum'
SOURCE_REF: Final[str] = 'src_4470'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4470
...
PROBLEM_TYPE_ID: Final[str] = 'text_short_quadratic_vertex_or_parameter_computation'
