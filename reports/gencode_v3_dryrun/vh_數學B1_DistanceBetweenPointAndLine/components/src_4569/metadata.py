...
COMPONENT_ID: Final[str] = "src_4569"
SKILL_ID: Final[str] = "vh_數學B1_DistanceBetweenPointAndLine"
SOURCE_REF: Final[str] = "src_4569"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4569
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "distance_from_point_to_line_parameter"
ANSWER_SCHEMA_KEY: Final[str] = "parameter_scalar"
LINE_TYPE: Final[str] = "distance_from_point_to_line_parameter"

TARGET_TASK: Final[str] = "distance_from_point_to_line_parameter"
TEMPLATE_SLOT: Final[str] = "distance_from_point_to_line_parameter"
PROBLEM_TYPE_ID: Final[str] = "distance_from_point_to_line_parameter"
