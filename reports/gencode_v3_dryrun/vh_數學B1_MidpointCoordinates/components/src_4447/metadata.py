...
COMPONENT_ID: Final[str] = "src_4447"
SKILL_ID: Final[str] = "vh_數學B1_MidpointCoordinates"
SOURCE_REF: Final[str] = "src_4447"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4447
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "inverse_centroid_vertex"
ANSWER_SCHEMA_KEY: Final[str] = "coordinate_pair"
LINE_TYPE: Final[str] = "inverse_centroid_vertex"

TARGET_TASK: Final[str] = "inverse_centroid_vertex"
TEMPLATE_SLOT: Final[str] = "inverse_centroid_vertex"
PROBLEM_TYPE_ID: Final[str] = "inverse_centroid_vertex"
