...
TEXTBOOK_EXAMPLE_ID = 4696
DEFAULT_COMPONENT_ID = "src_4696" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{2}}-6x+9$ (2)$4{{x}^{2}}+12x+9$'
