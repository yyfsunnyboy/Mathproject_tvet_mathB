...
TEXTBOOK_EXAMPLE_ID = 4701
DEFAULT_COMPONENT_ID = "src_4701" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '已知一正方形的邊長為正整數，其面積為$\\left( 6{{x}^{2}}-7x-5 \\right)$平方公分，且邊長可寫成x的一次式，試求此正方形的周長為多少公分？'
