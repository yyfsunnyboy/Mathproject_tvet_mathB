...
TEXTBOOK_EXAMPLE_ID = 4674
DEFAULT_COMPONENT_ID = "src_4674" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用十字交乘法因式分解$2{{x}^{2}}+5x-3$，得其因式分解為$\\left( ax+b \\right)\\left( x+c \\right)$，試求$a+b+c$之值。'
