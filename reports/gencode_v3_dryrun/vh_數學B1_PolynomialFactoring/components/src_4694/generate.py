...
TEXTBOOK_EXAMPLE_ID = 4694
DEFAULT_COMPONENT_ID = "src_4694" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '因式分解下列多項式：(1)$5\\left( x+1 \\right)-{{\\left( x+1 \\right)}^{2}}$ (2)${{x}^{3}}-3{{x}^{2}}+3x-9$.'
