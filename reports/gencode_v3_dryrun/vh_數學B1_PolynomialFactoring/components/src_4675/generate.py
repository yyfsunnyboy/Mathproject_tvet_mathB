...
TEXTBOOK_EXAMPLE_ID = 4675
DEFAULT_COMPONENT_ID = "src_4675" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '已知$P=4{{x}^{2}}-11x-3$是質數，x為正整數，試求：(1) x之值。(2) 此質數P。'
