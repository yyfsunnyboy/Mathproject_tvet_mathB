...
TEXTBOOK_EXAMPLE_ID = 4714
DEFAULT_COMPONENT_ID = "src_4714" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '如右圖，A、B、C為長方體相鄰的三面，其面積分別為${{x}^{2}}-x-6$、$2{{x}^{2}}-x-15$、$2{{x}^{2}}+9x+10$平方單位，則此長方體體積為多少立方單位？'
