...
TEXTBOOK_EXAMPLE_ID = 4690
DEFAULT_COMPONENT_ID = "src_4690" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '已知$\\frac{3}{3x-4}-\\frac{1}{2x+1}=\\frac{ax+b}{6{{x}^{2}}-5x-4}$，試求a、b之值。'
