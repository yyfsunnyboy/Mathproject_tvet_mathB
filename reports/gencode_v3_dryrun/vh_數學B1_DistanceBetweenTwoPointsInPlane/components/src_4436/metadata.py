...
COMPONENT_ID: Final[str] = "src_4436"
SKILL_ID: Final[str] = "vh_數學B1_DistanceBetweenTwoPointsInPlane"
SOURCE_REF: Final[str] = "src_4436"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4436
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_distance_between_two_points"
ANSWER_SCHEMA_KEY: Final[str] = "distance_scalar"
LINE_TYPE: Final[str] = "compute_distance_between_two_points"

TARGET_TASK: Final[str] = "compute_distance_between_two_points"
TEMPLATE_SLOT: Final[str] = "compute_distance_between_two_points"
PROBLEM_TYPE_ID: Final[str] = "compute_distance_between_two_points"
