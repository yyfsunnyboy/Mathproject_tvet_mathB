...
COMPONENT_ID: Final[str] = "src_4589"
SKILL_ID: Final[str] = "vh_數學B1_DistanceBetweenTwoParallelLines"
SOURCE_REF: Final[str] = "src_4589"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4589
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_parameter_from_parallel_distance"
ANSWER_SCHEMA_KEY: Final[str] = "parameter_scalar"
LINE_TYPE: Final[str] = "solve_parameter_from_parallel_distance"

TARGET_TASK: Final[str] = "solve_parameter_from_parallel_distance"
TEMPLATE_SLOT: Final[str] = "solve_parameter_from_parallel_distance"
PROBLEM_TYPE_ID: Final[str] = "solve_parameter_from_parallel_distance"
