...
COMPONENT_ID: Final[str] = "src_3826"
SKILL_ID: Final[str] = "vh_數學B4_HistogramsAndFrequencyPolygons"
SOURCE_REF: Final[str] = "src_3826"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3826
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "frequency_distribution_chart_construction"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "frequency_distribution_chart_construction"

TARGET_TASK: Final[str] = "frequency_distribution_chart_construction"
TEMPLATE_SLOT: Final[str] = "frequency_distribution_chart_construction"
PROBLEM_TYPE_ID: Final[str] = "frequency_distribution_chart_construction"
