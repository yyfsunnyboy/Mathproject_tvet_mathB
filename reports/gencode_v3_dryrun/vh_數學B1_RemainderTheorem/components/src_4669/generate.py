...
TEXTBOOK_EXAMPLE_ID = 4669
DEFAULT_COMPONENT_ID = "src_4669" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "若$f\\left( x \\right)=a{{x}^{2}}+bx-4$，除以x − 1得餘式為1，除以x + 1得餘式為3，試求實數a、b。"
