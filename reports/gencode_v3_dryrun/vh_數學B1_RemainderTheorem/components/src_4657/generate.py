...
TEXTBOOK_EXAMPLE_ID = 4657
DEFAULT_COMPONENT_ID = "src_4657" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "多項式$f\\left( x \\right)=2{{x}^{5}}-10{{x}^{4}}-8{{x}^{3}}-310{{x}^{2}}-1000$，試求$f\\left( 8 \\right)$的值。"
