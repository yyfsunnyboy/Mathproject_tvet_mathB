...
TEXTBOOK_EXAMPLE_ID = 4677
DEFAULT_COMPONENT_ID = "src_4677" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '化簡下列各式：(1)$\\frac{x+3}{x-1}-\\frac{5}{x-1}$ (2)$\\frac{x+1}{x+2}-\\frac{x}{x-4}$'
