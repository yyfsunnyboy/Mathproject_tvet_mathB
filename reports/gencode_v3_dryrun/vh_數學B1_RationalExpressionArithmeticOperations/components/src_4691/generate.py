...
TEXTBOOK_EXAMPLE_ID = 4691
DEFAULT_COMPONENT_ID = "src_4691" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '化簡$\\frac{2{{x}^{2}}-3x-2}{{{x}^{2}}-3x+2}\\div \\frac{2{{x}^{2}}-7x-4}{x-4}$。'
