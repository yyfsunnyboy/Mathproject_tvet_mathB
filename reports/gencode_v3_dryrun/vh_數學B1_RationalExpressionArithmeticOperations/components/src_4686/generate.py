...
TEXTBOOK_EXAMPLE_ID = 4686
DEFAULT_COMPONENT_ID = "src_4686" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '化簡$\\frac{{{x}^{2}}-4}{{{x}^{2}}-3x+2}\\times \\frac{x-1}{x+2}$。'
