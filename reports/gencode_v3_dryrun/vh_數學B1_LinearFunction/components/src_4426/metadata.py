...
COMPONENT_ID: Final[str] = "src_4426"
SKILL_ID: Final[str] = "vh_數學B1_LinearFunction"
SOURCE_REF: Final[str] = "src_4426"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4426
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "collinear_trisection_coordinate"
ANSWER_SCHEMA_KEY: Final[str] = "coordinate_pair"
LINE_TYPE: Final[str] = "collinear_trisection_coordinate"

TARGET_TASK: Final[str] = "collinear_trisection_coordinate"
TEMPLATE_SLOT: Final[str] = "collinear_trisection_coordinate"
PROBLEM_TYPE_ID: Final[str] = "collinear_trisection_coordinate"
