...
COMPONENT_ID: Final[str] = "src_4516"
SKILL_ID: Final[str] = "vh_數學B1_LinearFunction"
SOURCE_REF: Final[str] = "src_4516"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4516
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "linear_graph_feasibility_choice"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "linear_graph_feasibility_choice"

TARGET_TASK: Final[str] = "linear_graph_feasibility_choice"
TEMPLATE_SLOT: Final[str] = "linear_graph_feasibility_choice"
PROBLEM_TYPE_ID: Final[str] = "linear_graph_feasibility_choice"
