...
COMPONENT_ID: Final[str] = "src_4433"
SKILL_ID: Final[str] = "vh_數學B1_LinearFunction"
SOURCE_REF: Final[str] = "src_4433"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4433
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "draw_constant_function_graph"
ANSWER_SCHEMA_KEY: Final[str] = "drawing_spec"
LINE_TYPE: Final[str] = "draw_constant_function_graph"

TARGET_TASK: Final[str] = "draw_constant_function_graph"
TEMPLATE_SLOT: Final[str] = "draw_constant_function_graph"
PROBLEM_TYPE_ID: Final[str] = "draw_constant_function_graph"
