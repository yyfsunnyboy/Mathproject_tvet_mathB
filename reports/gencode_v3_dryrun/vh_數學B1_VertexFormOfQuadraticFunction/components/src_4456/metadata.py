...
COMPONENT_ID: Final[str] = 'src_4456'
SKILL_ID: Final[str] = 'vh_數學B1_VertexFormOfQuadraticFunction'
SOURCE_REF: Final[str] = 'src_4456'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4456
...
PROBLEM_TYPE_ID: Final[str] = 'numeric_quadratic_vertex_or_parameter_computation_short_answer'
