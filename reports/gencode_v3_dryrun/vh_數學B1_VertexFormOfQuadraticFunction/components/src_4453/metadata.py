...
COMPONENT_ID: Final[str] = 'src_4453'
SKILL_ID: Final[str] = 'vh_數學B1_VertexFormOfQuadraticFunction'
SOURCE_REF: Final[str] = 'src_4453'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4453
IS_REQUIRED_CORE: Final[bool] = False
ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'quadratic_vertex_form_properties'
TARGET_TASK: Final[str] = 'quadratic_vertex_form_properties'
TEMPLATE_SLOT: Final[str] = 'quadratic_vertex_form_properties'
PROBLEM_TYPE_ID: Final[str] = 'single_choice_quadratic_vertex_form_properties_single_choice'
