...
COMPONENT_ID: Final[str] = 'src_4452'
SKILL_ID: Final[str] = 'vh_數學B1_VertexFormOfQuadraticFunction'
SOURCE_REF: Final[str] = 'src_4452'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4452
IS_REQUIRED_CORE: Final[bool] = False
ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'quadratic_vertex_form_translation_to_new_function'
TARGET_TASK: Final[str] = 'quadratic_vertex_form_translation_to_new_function'
TEMPLATE_SLOT: Final[str] = 'quadratic_vertex_form_translation_to_new_function'
PROBLEM_TYPE_ID: Final[str] = 'text_quadratic_vertex_form_translation_to_new_function_short_answer'
