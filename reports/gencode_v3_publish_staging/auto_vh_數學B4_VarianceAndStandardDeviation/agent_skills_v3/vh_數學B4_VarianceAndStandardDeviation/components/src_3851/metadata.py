...
COMPONENT_ID: Final[str] = "src_3851"
SKILL_ID: Final[str] = "vh_數學B4_VarianceAndStandardDeviation"
SOURCE_REF: Final[str] = "src_3851"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3851
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_sample_standard_deviation"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_sample_standard_deviation"

TARGET_TASK: Final[str] = "compute_sample_standard_deviation"
TEMPLATE_SLOT: Final[str] = "compute_sample_standard_deviation"
PROBLEM_TYPE_ID: Final[str] = "compute_sample_standard_deviation"
