...
COMPONENT_ID: Final[str] = "src_4717"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialEquality"
SOURCE_REF: Final[str] = "src_4717"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4717
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "polynomial_equality_identity"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_equality_identity"

TARGET_TASK: Final[str] = "polynomial_equality_identity"
TEMPLATE_SLOT: Final[str] = "polynomial_equality_identity"
PROBLEM_TYPE_ID: Final[str] = "polynomial_equality_identity"
