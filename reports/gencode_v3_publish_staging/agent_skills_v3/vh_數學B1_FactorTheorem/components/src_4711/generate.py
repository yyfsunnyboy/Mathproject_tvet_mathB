...
TEXTBOOK_EXAMPLE_ID = 4711
DEFAULT_COMPONENT_ID = "src_4711" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "若多項式$f\\left( x \\right)=a{{x}^{2}}\\left( x+3 \\right)+5x\\left( x+3 \\right)+2\\left( x+3 \\right)$被x + 2除盡，則a = (A) −2 (B) −1 (C) 1 (D) 2。"
...
def generate(level: int = 1, seed: int | None = None, **kwargs: Any) -> dict[str, Any]:
    ...
    constraints = dict({'v3_induced_spec': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_FactorTheorem', 'source_example_id': 4711, 'textbook_example_id': 4711, 'source_hash': '1cbfd2708bc9db90ed1dfbbc61fdb00a', 'problem_type_id': 'factor_theorem_root_factor', 'required_capabilities': ['factor_theorem_root_factor'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'single_choice', 'answer_contract': {'answer_type': 'choice', 'checker_key': 'choice_label_checker', 'equivalence_type': 'choice_label'}, 'answer_type': 'choice'}, 'phase1_classification': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_FactorTheorem', 'source_example_id': 4711, 'textbook_example_id': 4711, 'source_hash': '1cbfd2708bc9db90ed1dfbbc61fdb00a', 'problem_type_id': 'factor_theorem_root_factor', 'required_capabilities': ['factor_theorem_root_factor'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'single_choice', 'answer_contract': {'answer_type': 'choice', 'checker_key': 'choice_label_checker', 'equivalence_type': 'choice_label'}, 'answer_type': 'choice'}, 'problem_type_id': 'factor_theorem_root_factor', 'required_capabilities': ['factor_theorem_root_factor'], 'classification_source': 'phase1_rule_pack', 'source_hash': '1cbfd2708bc9db90ed1dfbbc61fdb00a', 'presentation_mode': 'single_choice', 'answer_contract': {'answer_type': 'choice', 'checker_key': 'choice_label_checker', 'equivalence_type': 'choice_label'}, 'source_example_id': 4711, 'answer_type': 'choice', 'exact_task_operation': '', 'source_choices': [{'key': 'A', 'label': 'A', 'text': '−2'}, {'key': 'B', 'label': 'B', 'text': '−1'}, {'key': 'C', 'label': 'C', 'text': '1'}, {'key': 'D', 'label': 'D', 'text': '2'}], 'source_answer_label': 'D', 'domain_resolution': {'skill_id': 'vh_數學B1_FactorTheorem', 'fixed_domain_key': 'algebra.polynomial', 'resolution_source': 'confirmed_binding', 'binding_status': 'confirmed', 'required_capabilities': ['factor_theorem_root_factor'], 'matched_capabilities': ['factor_theorem_root_factor'], 'selected_operation': 'factor_theorem_root_factor', 'registry_revision': '2026-06-23-v1.8', 'domain_module': 'core.domain.polynomial_domain', 'entrypoint': 'build_polynomial_matrix', 'allowed_operations': ['factor_theorem_root_factor'], 'curriculum_profile': 'vocational_high_b'}, 'skill_id': 'vh_數學B1_FactorTheorem'})
