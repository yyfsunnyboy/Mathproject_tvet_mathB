...
TEXTBOOK_EXAMPLE_ID = 4651
DEFAULT_COMPONENT_ID = "src_4651" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設$f\\left( x \\right)=5{{x}^{4}}+13{{x}^{3}}-18{{x}^{2}}+ax+6$，若x − 1能整除$f\\left( x \\right)$，試求a之值。"
