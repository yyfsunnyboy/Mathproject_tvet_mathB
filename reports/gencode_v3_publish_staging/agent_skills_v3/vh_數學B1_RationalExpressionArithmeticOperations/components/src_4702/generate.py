...
TEXTBOOK_EXAMPLE_ID = 4702
DEFAULT_COMPONENT_ID = "src_4702" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '化簡$\\frac{{{x}^{2}}-1}{{{x}^{2}}-4x-12}\\times \\frac{x-6}{x+1}$。'
