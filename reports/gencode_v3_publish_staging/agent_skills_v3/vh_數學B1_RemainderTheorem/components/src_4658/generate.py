...
TEXTBOOK_EXAMPLE_ID = 4658
DEFAULT_COMPONENT_ID = "src_4658" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "若$f\\left( x \\right)=2{{x}^{3}}+a{{x}^{2}}+bx-1$，除以x + 1得餘式為−3，除以x − 2得餘式為3，試求實數a、b。"
