...
TEXTBOOK_EXAMPLE_ID = 4645
DEFAULT_COMPONENT_ID = "src_4645" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設多項式$f\\left( x \\right)$以x − 3、x + 1除之，其餘式分別為−2、6，試求$f\\left( x \\right)$除以$\\left( x-3 \\right)\\left( x+1 \\right)$的餘式。"
