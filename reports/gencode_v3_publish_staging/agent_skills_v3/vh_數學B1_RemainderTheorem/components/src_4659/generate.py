...
TEXTBOOK_EXAMPLE_ID = 4659
DEFAULT_COMPONENT_ID = "src_4659" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設多項式$f\\left( x \\right)$除以x + 1的餘式為2；除以x − 2的餘式為5，試求$f\\left( x \\right)$除以$\\left( x+1 \\right)\\left( x-2 \\right)$的餘式。"
