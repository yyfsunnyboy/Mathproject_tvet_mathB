...
TEXTBOOK_EXAMPLE_ID = 4665
DEFAULT_COMPONENT_ID = "src_4665" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "求多項式$f\\left( x \\right)={{x}^{5}}-2{{x}^{3}}+4$除以x − 2的餘式與除以x + 2的餘式。."
