...
TEXTBOOK_EXAMPLE_ID = 4668
DEFAULT_COMPONENT_ID = "src_4668" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "多項式$f\\left( x \\right)=3{{x}^{4}}-5{{x}^{3}}-130x+50$，試求$f\\left( 5 \\right)$的值。"
