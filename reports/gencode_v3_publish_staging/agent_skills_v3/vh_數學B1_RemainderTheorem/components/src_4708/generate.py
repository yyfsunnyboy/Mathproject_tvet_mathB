...
TEXTBOOK_EXAMPLE_ID = 4708
DEFAULT_COMPONENT_ID = "src_4708" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設a、b為實數，已知多項式$f\\left( x \\right)=2{{x}^{3}}-{{x}^{2}}-ax+b$除以x − 1之餘式為−3，且除以x + 1之餘式為3，則a − b之值為 (A) 3 (B) 4 (C) 5 (D) 6。"
