...
TEXTBOOK_EXAMPLE_ID = 4614
DEFAULT_COMPONENT_ID = "src_4614" if TEXTBOOK_EXAMPLE_ID else ""
...
def generate(level: int = 1, seed: int | None = None, **kwargs: Any) -> dict[str, Any]:
    ...
    constraints = dict({'v3_induced_spec': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_PolynomialArithmeticOperations', 'source_example_id': 4614, 'textbook_example_id': 4614, 'source_hash': 'ee55b6fd68155727847275887b659f5f', 'problem_type_id': 'polynomial_long_division', 'required_capabilities': ['polynomial_long_division'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'phase1_classification': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_PolynomialArithmeticOperations', 'source_example_id': 4614, 'textbook_example_id': 4614, 'source_hash': 'ee55b6fd68155727847275887b659f5f', 'problem_type_id': 'polynomial_long_division', 'required_capabilities': ['polynomial_long_division'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'problem_type_id': 'polynomial_long_division', 'required_capabilities': ['polynomial_long_division'], 'classification_source': 'phase1_rule_pack', 'source_hash': 'ee55b6fd68155727847275887b659f5f', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'source_example_id': 4614, 'answer_type': 'expression', 'exact_task_operation': '', 'domain_resolution': {'skill_id': 'vh_數學B1_PolynomialArithmeticOperations', 'fixed_domain_key': 'algebra.polynomial', 'resolution_source': 'confirmed_binding', 'binding_status': 'confirmed', 'required_capabilities': ['polynomial_long_division'], 'matched_capabilities': ['polynomial_long_division'], 'selected_operation': 'polynomial_long_division', 'registry_revision': '2026-06-23-v1.8', 'domain_module': 'core.domain.polynomial_domain', 'entrypoint': 'build_polynomial_matrix', 'allowed_operations': ['polynomial_add_sub', 'polynomial_multiply', 'polynomial_product_term_coefficient', 'polynomial_long_division', 'polynomial_synthetic_division', 'polynomial_remainder_param_solve', 'polynomial_shifted_basis_eval'], 'curriculum_profile': 'vocational_high_b'}, 'skill_id': 'vh_數學B1_PolynomialArithmeticOperations'})
