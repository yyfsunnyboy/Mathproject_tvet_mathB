...
COMPONENT_ID: Final[str] = "src_4609"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialBasicConcepts"
SOURCE_REF: Final[str] = "src_4609"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4609
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "polynomial_descending_power_properties"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_descending_power_properties"

TARGET_TASK: Final[str] = "polynomial_descending_power_properties"
TEMPLATE_SLOT: Final[str] = "polynomial_descending_power_properties"
PROBLEM_TYPE_ID: Final[str] = "polynomial_descending_power_properties"
