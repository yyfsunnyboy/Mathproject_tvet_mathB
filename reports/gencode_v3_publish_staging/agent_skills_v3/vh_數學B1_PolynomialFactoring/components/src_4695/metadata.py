...
COMPONENT_ID: Final[str] = "src_4695"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialFactoring"
SOURCE_REF: Final[str] = "src_4695"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4695
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "polynomial_factoring"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_factoring"

TARGET_TASK: Final[str] = "polynomial_factoring"
TEMPLATE_SLOT: Final[str] = "polynomial_factoring"
PROBLEM_TYPE_ID: Final[str] = "polynomial_factoring"
