...
TEXTBOOK_EXAMPLE_ID = 4695
DEFAULT_COMPONENT_ID = "src_4695" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{2}}-4$ (2)${{\\left( a+b \\right)}^{2}}-25$。'
