...
TEXTBOOK_EXAMPLE_ID = 4682
DEFAULT_COMPONENT_ID = "src_4682" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{2}}-1$ (2)${{\\left( a+2 \\right)}^{2}}-9$'
