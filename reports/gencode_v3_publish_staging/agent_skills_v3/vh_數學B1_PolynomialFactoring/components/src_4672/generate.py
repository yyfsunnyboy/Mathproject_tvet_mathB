...
TEXTBOOK_EXAMPLE_ID = 4672
DEFAULT_COMPONENT_ID = "src_4672" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{2}}-4x+4$(2)$4{{a}^{2}}+12ab+9{{b}^{2}}$(3)$5{{x}^{2}}-20$'
