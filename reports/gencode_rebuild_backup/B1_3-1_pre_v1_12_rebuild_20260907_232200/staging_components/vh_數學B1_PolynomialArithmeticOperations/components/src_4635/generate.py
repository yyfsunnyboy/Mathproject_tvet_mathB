...
TEXTBOOK_EXAMPLE_ID = 4635
DEFAULT_COMPONENT_ID = "src_4635" if TEXTBOOK_EXAMPLE_ID else ""
...
def generate(level: int = 1, seed: int | None = None, **kwargs: Any) -> dict[str, Any]:
    ...
    constraints = dict({'v3_induced_spec': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_PolynomialArithmeticOperations', 'source_example_id': 4635, 'textbook_example_id': 4635, 'source_hash': '2fd466516387b2f2c7bab64e3d4dcb2a', 'problem_type_id': 'polynomial_product_term_coefficient', 'required_capabilities': ['polynomial_product_term_coefficient'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'phase1_classification': {'classification_status': 'resolved', 'skill_id': 'vh_數學B1_PolynomialArithmeticOperations', 'source_example_id': 4635, 'textbook_example_id': 4635, 'source_hash': '2fd466516387b2f2c7bab64e3d4dcb2a', 'problem_type_id': 'polynomial_product_term_coefficient', 'required_capabilities': ['polynomial_product_term_coefficient'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'problem_type_id': 'polynomial_product_term_coefficient', 'required_capabilities': ['polynomial_product_term_coefficient'], 'classification_source': 'phase1_rule_pack', 'source_hash': '2fd466516387b2f2c7bab64e3d4dcb2a', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'source_example_id': 4635, 'answer_type': 'expression', 'exact_task_operation': '', 'domain_resolution': {'skill_id': 'vh_數學B1_PolynomialArithmeticOperations', 'fixed_domain_key': 'algebra.polynomial', 'resolution_source': 'confirmed_binding', 'binding_status': 'confirmed', 'required_capabilities': ['polynomial_product_term_coefficient'], 'matched_capabilities': ['polynomial_product_term_coefficient'], 'selected_operation': '', 'registry_revision': '2026-06-23-v1.8', 'domain_module': 'core.domain.polynomial_domain', 'entrypoint': 'build_polynomial_matrix', 'allowed_operations': ['polynomial_add_sub', 'polynomial_multiply', 'polynomial_product_term_coefficient', 'polynomial_long_division', 'polynomial_synthetic_division', 'polynomial_remainder_param_solve', 'polynomial_shifted_basis_eval'], 'curriculum_profile': 'vocational_high_b'}, 'skill_id': 'vh_數學B1_PolynomialArithmeticOperations'})
