...
COMPONENT_ID: Final[str] = "src_4630"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialBasicConcepts"
SOURCE_REF: Final[str] = "src_4630"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4630
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "polynomial_param_degree_constraint"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_param_degree_constraint"

TARGET_TASK: Final[str] = "polynomial_param_degree_constraint"
TEMPLATE_SLOT: Final[str] = "polynomial_param_degree_constraint"
PROBLEM_TYPE_ID: Final[str] = "polynomial_param_degree_constraint"
