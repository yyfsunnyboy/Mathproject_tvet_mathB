...
COMPONENT_ID: Final[str] = "src_4617"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialArithmeticOperations"
SOURCE_REF: Final[str] = "src_4617"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4617
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "polynomial_shifted_basis_eval"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_shifted_basis_eval"

TARGET_TASK: Final[str] = "polynomial_shifted_basis_eval"
TEMPLATE_SLOT: Final[str] = "polynomial_shifted_basis_eval"
PROBLEM_TYPE_ID: Final[str] = "polynomial_shifted_basis_eval"
