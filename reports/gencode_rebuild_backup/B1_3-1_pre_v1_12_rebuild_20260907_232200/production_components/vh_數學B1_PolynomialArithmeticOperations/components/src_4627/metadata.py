...
COMPONENT_ID: Final[str] = "src_4627"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialArithmeticOperations"
SOURCE_REF: Final[str] = "src_4627"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4627
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "polynomial_remainder_param_solve"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_remainder_param_solve"

TARGET_TASK: Final[str] = "polynomial_remainder_param_solve"
TEMPLATE_SLOT: Final[str] = "polynomial_remainder_param_solve"
PROBLEM_TYPE_ID: Final[str] = "polynomial_remainder_param_solve"
