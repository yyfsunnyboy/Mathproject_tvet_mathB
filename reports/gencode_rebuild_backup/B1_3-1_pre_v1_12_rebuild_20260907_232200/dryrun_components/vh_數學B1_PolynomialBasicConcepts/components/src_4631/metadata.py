...
COMPONENT_ID: Final[str] = "src_4631"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialBasicConcepts"
SOURCE_REF: Final[str] = "src_4631"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4631
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "zero_polynomial_find_coeffs"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "zero_polynomial_find_coeffs"

TARGET_TASK: Final[str] = "zero_polynomial_find_coeffs"
TEMPLATE_SLOT: Final[str] = "zero_polynomial_find_coeffs"
PROBLEM_TYPE_ID: Final[str] = "zero_polynomial_find_coeffs"
