...
COMPONENT_ID: Final[str] = "src_4625"
SKILL_ID: Final[str] = "vh_數學B1_PolynomialArithmeticOperations"
SOURCE_REF: Final[str] = "src_4625"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4625
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "polynomial_long_division"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "polynomial_long_division"

TARGET_TASK: Final[str] = "polynomial_long_division"
TEMPLATE_SLOT: Final[str] = "polynomial_long_division"
PROBLEM_TYPE_ID: Final[str] = "polynomial_long_division"
