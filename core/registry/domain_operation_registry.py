...
register_domain_spec(DomainCapabilitySpec(
    ...
    operations={
        ...
        "rational_equation_solve": _op(
            "rational_equation_solve",
            "build_polynomial_matrix",
            supported_answer_types=("solution_set", "expression", "multi_part"),
