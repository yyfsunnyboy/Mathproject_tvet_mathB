...
def validate_answer_contract(payload: dict[str, Any], problem_type_spec: dict[str, Any]) -> list[str]:
    ...
    answer_type = str(answer_contract.get("answer_type", "")).strip()
    ...
    equivalence = str(answer_contract.get("answer_equivalence", "exact_text")).strip()
    if answer_type == "numeric" and equivalence == "numeric_equal":
