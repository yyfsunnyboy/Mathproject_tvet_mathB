...
#
# [Key Functions]:
#   Shared helpers retained for scaler / live_show / validators / healers.
#   GENCODE V2 entry auto_generate_skill_code has been retired; use /skills V3.
#
# [Note]:
#   Do not reintroduce auto_generate_skill_code. Generation is V3-only.
# ============================================================================== 
