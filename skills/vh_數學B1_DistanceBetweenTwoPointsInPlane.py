...
GENERATOR_SPECS = [{'problem_type_id': 'short_answer_solve_unknown_coordinate_from_two_point_distance_coordinate_point_d_2', 'checker_key': 'text_checker', 'equivalence_type': 'exact_string', 'generator_readiness': 'runtime_ready'}, {'problem_type_id': 'short_answer_compute_distance_between_two_points_coordinate_point_distance_formu_2', 'checker_key': 'text_checker', 'equivalence_type': 'exact_string', 'generator_readiness': 'runtime_ready'}]
