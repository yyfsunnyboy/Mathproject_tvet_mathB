...
GENERATOR_KEYS = ['vh_數學B1_QuadraticFunctionGraph:text_short_contextual_application:draft_v1', 'vh_數學B1_QuadraticFunctionGraph:text_short_contextual_application:draft_v1']
GENERATOR_SPECS = [{'problem_type_id': 'text_short_contextual_application', 'checker_key': 'text_short_checker', 'equivalence_type': 'exact_string', 'generator_readiness': 'runtime_ready'}, {'problem_type_id': 'text_short_contextual_application', 'checker_key': 'text_short_checker', 'equivalence_type': 'exact_string', 'generator_readiness': 'runtime_ready'}]
