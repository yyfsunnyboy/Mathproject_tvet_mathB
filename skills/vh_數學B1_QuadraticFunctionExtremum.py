...
GENERATOR_SPECS = [{'problem_type_id': 'integer_compute_quadratic_vertex', 'checker_key': 'integer_checker', 'equivalence_type': 'numeric_exact', 'generator_readiness': 'runtime_ready', 'answer_type': 'integer', 'template_slot': 'quadratic_vertex_extremum_rational', 'base_problem_type_id': 'compute_quadratic_vertex', 'value_type_prefix': 'integer', 'presentation_mode': 'short_answer', 'answer_shape': 'scalar'}, {'problem_type_id': 'integer_quadratic_vertex_or_parameter_computation', 'checker_key': 'integer_checker', 'equivalence_type': 'numeric_exact', 'generator_readiness': 'runtime_ready', 'answer_type': 'integer', 'template_slot': 'quadratic_vertex_or_parameter_computation', 'base_problem_type_id': 'quadratic_vertex_or_parameter_computation', 'value_type_prefix': 'integer', 'presentation_mode': 'short_answer', 'answer_shape': 'scalar'}, {'problem_type_id': 'text_short_quadratic_vertex_or_parameter_computation', 'checker_key': 'rational_checker', 'equivalence_type': 'rational_equivalent', 'generator_readiness': 'runtime_ready', 'answer_type': 'rational', 'template_slot': 'quadratic_vertex_or_parameter_computation', 'base_problem_type_id': 'quadratic_vertex_or_parameter_computation', 'value_type_prefix': 'text_short', 'presentation_mode': 'short_answer', 'answer_shape': 'scalar'}]
