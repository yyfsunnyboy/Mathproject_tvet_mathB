...
VERIFIED_CANDIDATE_MODULES = {'text_short_slope_of_line_problems': 'generated_candidates/vocational_math_b1/section_2_1/text_short_slope_of_line_problems/candidate_v1.py'}
