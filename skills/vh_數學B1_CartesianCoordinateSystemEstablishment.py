...
VERIFIED_CANDIDATE_MODULES = {'cartesian_coordinate_quadrant_symbol_reasoning': 'generated_candidates/vocational_math_b1/section_1_2/cartesian_coordinate_quadrant_symbol_reasoning/candidate_v1.py'}
