# skills/jh_gcf_calc_prime_factor.py
import random
import math
...
def generate(level=1):
    ...
    question_text = f"已知 A = {format_factorization(factors_a)} 且 B = {format_factorization(factors_b)}，請問 A 和 B 的最大公因數是多少？"
    
    correct_answer = str(math.gcd(a, b))

    context_string = f"求最大公因數，取共同質因數，次方取較小者。"
