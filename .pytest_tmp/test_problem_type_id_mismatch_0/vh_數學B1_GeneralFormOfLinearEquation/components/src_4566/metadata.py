...
COMPONENT_ID: Final[str] = "src_4566"
SKILL_ID: Final[str] = "vh_數學B1_GeneralFormOfLinearEquation"
SOURCE_REF: Final[str] = "src_4566"
SOURCE_KIND: Final[str] = "ex_4566"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4566
...
TARGET_TASK: Final[str] = "wrong_problem_type"
TEMPLATE_SLOT: Final[str] = "line_equation_from_point_slope"
PROBLEM_TYPE_ID: Final[str] = "wrong_problem_type"
