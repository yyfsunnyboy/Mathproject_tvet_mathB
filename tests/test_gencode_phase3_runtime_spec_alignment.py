...
from core.gencode.pipeline_orchestrator import _sync_phase3_runtime_specs_from_draft
...
def test_phase3_runtime_alignment_syncs_only_usable_reinforced_drafts(tmp_path):
    ...
    assert "phase3_historical_problem_type_downgraded" in historical_row["warnings"]
