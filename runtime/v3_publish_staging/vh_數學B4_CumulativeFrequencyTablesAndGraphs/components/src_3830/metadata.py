...
COMPONENT_ID: Final[str] = "src_3830"
SKILL_ID: Final[str] = "vh_數學B4_CumulativeFrequencyTablesAndGraphs"
SOURCE_REF: Final[str] = "src_3830"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3830
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "cumulative_frequency_graph_reading"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "cumulative_frequency_graph_reading"

TARGET_TASK: Final[str] = "cumulative_frequency_graph_reading"
TEMPLATE_SLOT: Final[str] = "cumulative_frequency_graph_reading"
PROBLEM_TYPE_ID: Final[str] = "cumulative_frequency_graph_reading"
