...
COMPONENT_ID: Final[str] = "src_4584"
SKILL_ID: Final[str] = "vh_數學B1_DistanceBetweenTwoParallelLines"
SOURCE_REF: Final[str] = "src_4584"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4584
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "parallel_lines_distance_single_choice"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "parallel_lines_distance_single_choice"

TARGET_TASK: Final[str] = "parallel_lines_distance_single_choice"
TEMPLATE_SLOT: Final[str] = "parallel_lines_distance_single_choice"
PROBLEM_TYPE_ID: Final[str] = "parallel_lines_distance_single_choice"
