...
COMPONENT_ID: Final[str] = "src_3836"
SKILL_ID: Final[str] = "vh_數學B4_CentralTendencyMeasures"
SOURCE_REF: Final[str] = "src_3836"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3836
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_median_from_raw_values"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_median_from_raw_values"

TARGET_TASK: Final[str] = "compute_median_from_raw_values"
TEMPLATE_SLOT: Final[str] = "compute_median_from_raw_values"
PROBLEM_TYPE_ID: Final[str] = "compute_median_from_raw_values"
