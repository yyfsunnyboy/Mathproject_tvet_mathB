...
COMPONENT_ID: Final[str] = "src_11860"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_3"
SOURCE_REF: Final[str] = "src_11860"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11860
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "tangent_at_point_on_circle"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "tangent_at_point_on_circle"

TARGET_TASK: Final[str] = "tangent_at_point_on_circle"
TEMPLATE_SLOT: Final[str] = "tangent_at_point_on_circle"
PROBLEM_TYPE_ID: Final[str] = "tangent_at_point_on_circle"
