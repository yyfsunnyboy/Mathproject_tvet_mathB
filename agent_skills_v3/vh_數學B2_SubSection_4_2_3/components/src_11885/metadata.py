...
COMPONENT_ID: Final[str] = "src_11885"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_3"
SOURCE_REF: Final[str] = "src_11885"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11885
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "tangent_at_point_on_circle_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "tangent_at_point_on_circle_mcq"

TARGET_TASK: Final[str] = "tangent_at_point_on_circle_mcq"
TEMPLATE_SLOT: Final[str] = "tangent_at_point_on_circle_mcq"
PROBLEM_TYPE_ID: Final[str] = "tangent_at_point_on_circle_mcq"
