...
COMPONENT_ID: Final[str] = "src_11895"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_3"
SOURCE_REF: Final[str] = "src_11895"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11895
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_tangents_from_point_quad_area"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "compute_tangents_from_point_quad_area"

TARGET_TASK: Final[str] = "compute_tangents_from_point_quad_area"
TEMPLATE_SLOT: Final[str] = "compute_tangents_from_point_quad_area"
PROBLEM_TYPE_ID: Final[str] = "compute_tangents_from_point_quad_area"
