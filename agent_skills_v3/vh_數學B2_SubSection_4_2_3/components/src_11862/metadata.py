...
COMPONENT_ID: Final[str] = "src_11862"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_3"
SOURCE_REF: Final[str] = "src_11862"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11862
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "tangents_perpendicular_to_line"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "tangents_perpendicular_to_line"

TARGET_TASK: Final[str] = "tangents_perpendicular_to_line"
TEMPLATE_SLOT: Final[str] = "tangents_perpendicular_to_line"
PROBLEM_TYPE_ID: Final[str] = "tangents_perpendicular_to_line"
