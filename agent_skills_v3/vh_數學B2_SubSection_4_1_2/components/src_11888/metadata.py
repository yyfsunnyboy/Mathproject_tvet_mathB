...
COMPONENT_ID: Final[str] = "src_11888"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11888"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11888
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_circle_area_from_general"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_circle_area_from_general"

TARGET_TASK: Final[str] = "compute_circle_area_from_general"
TEMPLATE_SLOT: Final[str] = "compute_circle_area_from_general"
PROBLEM_TYPE_ID: Final[str] = "compute_circle_area_from_general"
