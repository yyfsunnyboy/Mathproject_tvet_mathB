...
COMPONENT_ID: Final[str] = "src_11892"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11892"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11892
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "circle_through_three_points"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "circle_through_three_points"

TARGET_TASK: Final[str] = "circle_through_three_points"
TEMPLATE_SLOT: Final[str] = "circle_through_three_points"
PROBLEM_TYPE_ID: Final[str] = "circle_through_three_points"
