...
COMPONENT_ID: Final[str] = "src_11832"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11832"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11832
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "identify_center_radius_from_general"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "identify_center_radius_from_general"

TARGET_TASK: Final[str] = "identify_center_radius_from_general"
TEMPLATE_SLOT: Final[str] = "identify_center_radius_from_general"
PROBLEM_TYPE_ID: Final[str] = "identify_center_radius_from_general"
