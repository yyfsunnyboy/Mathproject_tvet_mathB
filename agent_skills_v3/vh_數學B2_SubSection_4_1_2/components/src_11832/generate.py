...
PROBLEM_TYPE_ID = "identify_center_radius_from_general"
TEXTBOOK_EXAMPLE_ID = 11832
DEFAULT_COMPONENT_ID = "src_11832" if TEXTBOOK_EXAMPLE_ID else ""
