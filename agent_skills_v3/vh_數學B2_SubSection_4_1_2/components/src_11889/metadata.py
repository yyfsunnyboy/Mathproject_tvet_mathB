...
COMPONENT_ID: Final[str] = "src_11889"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11889"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11889
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "identify_circle_from_product_form"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "identify_circle_from_product_form"

TARGET_TASK: Final[str] = "identify_circle_from_product_form"
TEMPLATE_SLOT: Final[str] = "identify_circle_from_product_form"
PROBLEM_TYPE_ID: Final[str] = "identify_circle_from_product_form"
