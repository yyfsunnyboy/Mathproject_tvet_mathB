...
COMPONENT_ID: Final[str] = "src_11846"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11846"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11846
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "classify_general_circle_graph"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "classify_general_circle_graph"

TARGET_TASK: Final[str] = "classify_general_circle_graph"
TEMPLATE_SLOT: Final[str] = "classify_general_circle_graph"
PROBLEM_TYPE_ID: Final[str] = "classify_general_circle_graph"
