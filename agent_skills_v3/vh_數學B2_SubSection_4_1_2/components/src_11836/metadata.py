...
COMPONENT_ID: Final[str] = "src_11836"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11836"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11836
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_circle_parameter_range"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_circle_parameter_range"

TARGET_TASK: Final[str] = "solve_circle_parameter_range"
TEMPLATE_SLOT: Final[str] = "solve_circle_parameter_range"
PROBLEM_TYPE_ID: Final[str] = "solve_circle_parameter_range"
