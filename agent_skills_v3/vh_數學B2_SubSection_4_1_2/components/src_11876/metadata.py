...
COMPONENT_ID: Final[str] = "src_11876"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_2"
SOURCE_REF: Final[str] = "src_11876"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11876
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "evaluate_center_radius_expression"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "evaluate_center_radius_expression"

TARGET_TASK: Final[str] = "evaluate_center_radius_expression"
TEMPLATE_SLOT: Final[str] = "evaluate_center_radius_expression"
PROBLEM_TYPE_ID: Final[str] = "evaluate_center_radius_expression"
