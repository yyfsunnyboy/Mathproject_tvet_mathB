...
COMPONENT_ID: Final[str] = 'src_4460'
SKILL_ID: Final[str] = 'vh_數學B1_QuadraticFunctionGraph'
SOURCE_REF: Final[str] = 'src_4460'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4460
...
PROBLEM_TYPE_ID: Final[str] = 'integer_quadratic_graph_translation_fill_blank'
