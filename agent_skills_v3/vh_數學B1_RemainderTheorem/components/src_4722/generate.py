...
TEXTBOOK_EXAMPLE_ID = 4722
DEFAULT_COMPONENT_ID = "src_4722" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設$f\\left( x \\right)=2{{x}^{3}}+2{{x}^{2}}-4x+a$除以x − 1的餘式為2，則a之值為 (A) 5 (B) 4 (C) 3 (D) 2。"
