...
TEXTBOOK_EXAMPLE_ID = 4721
DEFAULT_COMPONENT_ID = "src_4721" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設$f\\left( x \\right)={{x}^{101}}+98{{x}^{99}}+3{{x}^{2}}+99$，則以x + 1除$f\\left( x \\right)$之餘式為 (A) −3 (B) −4 (C) 3 (D) −5。"
