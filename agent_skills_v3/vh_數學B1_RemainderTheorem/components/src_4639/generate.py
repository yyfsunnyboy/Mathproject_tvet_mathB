...
TEXTBOOK_EXAMPLE_ID = 4639
DEFAULT_COMPONENT_ID = "src_4639" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "求多項式$f\\left( x \\right)={{x}^{100}}-x-2$除以x − 1的餘式與除以x + 1的餘式。"
