...
TEXTBOOK_EXAMPLE_ID = 4656
DEFAULT_COMPONENT_ID = "src_4656" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "試求${{\\left( 4{{x}^{2}}-2x-1 \\right)}^{3}}\\div \\left( 2x+1 \\right)$的餘式。"
