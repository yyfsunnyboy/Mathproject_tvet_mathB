...
TEXTBOOK_EXAMPLE_ID = 4642
DEFAULT_COMPONENT_ID = "src_4642" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "試求下列之餘式：(1) x − 1除$f\\left( x \\right)=3{{x}^{2018}}-5{{x}^{50}}+4$的餘式。(2)$f\\left( x \\right)=27{{x}^{3}}-9{{x}^{2}}+3x-5$除以3x + 1的餘式。"
