...
TEXTBOOK_EXAMPLE_ID = 4670
DEFAULT_COMPONENT_ID = "src_4670" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "設多項式$f\\left( x \\right)$除以x − 3的餘式為8；除以x + 2的餘式為−2，試求$f\\left( x \\right)$除以$\\left( x-3 \\right)\\left( x+2 \\right)$的餘式。."
