...
TEXTBOOK_EXAMPLE_ID = 4667
DEFAULT_COMPONENT_ID = "src_4667" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = "試求${{\\left( 8{{x}^{3}}-2x+3 \\right)}^{4}}\\div \\left( 2x-1 \\right)$的餘式。"
