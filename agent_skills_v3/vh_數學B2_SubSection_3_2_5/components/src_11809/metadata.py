...
COMPONENT_ID: Final[str] = "src_11809"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_5"
SOURCE_REF: Final[str] = "src_11809"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11809
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "solve_parallel_then_magnitude_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "solve_parallel_then_magnitude_mcq"

TARGET_TASK: Final[str] = "solve_parallel_then_magnitude_mcq"
TEMPLATE_SLOT: Final[str] = "solve_parallel_then_magnitude_mcq"
PROBLEM_TYPE_ID: Final[str] = "solve_parallel_then_magnitude_mcq"
