...
COMPONENT_ID: Final[str] = "src_11924"
SKILL_ID: Final[str] = 'vh_數學B3_SubSection_1_2_1'
SOURCE_REF: Final[str] = "src_11924"
SOURCE_KIND: Final[str] = 'example'
TEXTBOOK_EXAMPLE_ID: Final[int] = 11924
IS_REQUIRED_CORE: Final[bool] = True

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'geometric_nth_from_a1_r'
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = 'geometric_nth_from_a1_r'

TARGET_TASK: Final[str] = 'geometric_nth_from_a1_r'
TEMPLATE_SLOT: Final[str] = 'geometric_nth_from_a1_r'
PROBLEM_TYPE_ID: Final[str] = 'geometric_nth_from_a1_r'
