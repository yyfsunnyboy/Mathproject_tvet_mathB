...
COMPONENT_ID: Final[str] = "src_11927"
SKILL_ID: Final[str] = 'vh_數學B3_SubSection_1_2_1'
SOURCE_REF: Final[str] = "src_11927"
SOURCE_KIND: Final[str] = 'quiz'
TEXTBOOK_EXAMPLE_ID: Final[int] = 11927
IS_REQUIRED_CORE: Final[bool] = True

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'geometric_r_from_a1_an'
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = 'geometric_r_from_a1_an'

TARGET_TASK: Final[str] = 'geometric_r_from_a1_an'
TEMPLATE_SLOT: Final[str] = 'geometric_r_from_a1_an'
PROBLEM_TYPE_ID: Final[str] = 'geometric_r_from_a1_an'
