...
PROBLEM_TYPE_ID = 'geometric_growth_table_cells'
TEXTBOOK_EXAMPLE_ID = 11950
DEFAULT_COMPONENT_ID = "src_11950"
EXTRA_CONSTRAINTS = {'locked_stem': 'compound_growth_table'}
