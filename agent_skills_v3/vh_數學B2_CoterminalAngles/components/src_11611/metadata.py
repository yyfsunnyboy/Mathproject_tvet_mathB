...
COMPONENT_ID: Final[str] = "src_11611"
SKILL_ID: Final[str] = "vh_數學B2_CoterminalAngles"
SOURCE_REF: Final[src_11611] = "src_11611"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11611
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "identify_coterminal_angles_degree"
ANSWER_SCHEMA_KEY: Final[str] = "solution_set"
LINE_TYPE: Final[str] = "coterminal_angles"

TARGET_TASK: Final[str] = "identify_coterminal_angles_degree"
TEMPLATE_SLOT: Final[str] = "identify_coterminal_angles_degree"
