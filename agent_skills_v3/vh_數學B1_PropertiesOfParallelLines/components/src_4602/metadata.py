...
COMPONENT_ID: Final[str] = "src_4602"
SKILL_ID: Final[str] = "vh_數學B1_PropertiesOfParallelLines"
SOURCE_REF: Final[str] = "src_4602"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4602
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "parallel_two_point_lines_parameter_choice"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "parallel_two_point_lines_parameter_choice"

TARGET_TASK: Final[str] = "parallel_two_point_lines_parameter_choice"
TEMPLATE_SLOT: Final[str] = "parallel_two_point_lines_parameter_choice"
PROBLEM_TYPE_ID: Final[str] = "parallel_two_point_lines_parameter_choice"
