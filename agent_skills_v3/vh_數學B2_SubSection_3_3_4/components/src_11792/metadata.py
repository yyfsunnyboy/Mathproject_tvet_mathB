...
COMPONENT_ID: Final[str] = "src_11792"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_4"
SOURCE_REF: Final[str] = "src_11792"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11792
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_perpendicular_vector_parameter"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_perpendicular_vector_parameter"

TARGET_TASK: Final[str] = "solve_perpendicular_vector_parameter"
TEMPLATE_SLOT: Final[str] = "solve_perpendicular_vector_parameter"
PROBLEM_TYPE_ID: Final[str] = "solve_perpendicular_vector_parameter"
