...
COMPONENT_ID: Final[str] = "src_11814"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_4"
SOURCE_REF: Final[str] = "src_11814"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11814
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "solve_perpendicular_composite_parameter"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_perpendicular_composite_parameter"

TARGET_TASK: Final[str] = "solve_perpendicular_composite_parameter"
TEMPLATE_SLOT: Final[str] = "solve_perpendicular_composite_parameter"
PROBLEM_TYPE_ID: Final[str] = "solve_perpendicular_composite_parameter"
