...
COMPONENT_ID: Final[str] = "src_4407"
SKILL_ID: Final[str] = "vh_數學B1_AbsoluteValueInequality"
SOURCE_REF: Final[str] = "src_4407"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4407
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "absolute_value_inequality_linear_expression_basic"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "absolute_value_inequality_linear_expression_basic"

TARGET_TASK: Final[str] = "absolute_value_inequality_linear_expression_basic"
TEMPLATE_SLOT: Final[str] = "absolute_value_inequality_linear_expression_basic"
PROBLEM_TYPE_ID: Final[str] = "absolute_value_inequality_linear_expression_basic"
