...
COMPONENT_ID: Final[str] = "src_4425"
SKILL_ID: Final[str] = "vh_數學B1_LinearFunction"
SOURCE_REF: Final[str] = "src_4425"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4425
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "graph_based_tiered_linear_application_multi_part"
ANSWER_SCHEMA_KEY: Final[str] = "multi_part_scalar"
LINE_TYPE: Final[str] = "graph_based_tiered_linear_application_multi_part"

TARGET_TASK: Final[str] = "graph_based_tiered_linear_application_multi_part"
TEMPLATE_SLOT: Final[str] = "graph_based_tiered_linear_application_multi_part"
PROBLEM_TYPE_ID: Final[str] = "graph_based_tiered_linear_application_multi_part"
