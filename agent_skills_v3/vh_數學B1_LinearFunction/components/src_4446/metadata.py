...
COMPONENT_ID: Final[str] = "src_4446"
SKILL_ID: Final[str] = "vh_數學B1_LinearFunction"
SOURCE_REF: Final[str] = "src_4446"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4446
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "robust_budget_feasibility_choice"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "robust_budget_feasibility_choice"

TARGET_TASK: Final[str] = "robust_budget_feasibility_choice"
TEMPLATE_SLOT: Final[str] = "robust_budget_feasibility_choice"
PROBLEM_TYPE_ID: Final[str] = "robust_budget_feasibility_choice"
