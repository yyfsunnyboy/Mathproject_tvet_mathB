...
COMPONENT_ID: Final[str] = 'src_4501'
SKILL_ID: Final[str] = 'vh_數學B1_CompletingTheSquare'
SOURCE_REF: Final[str] = 'src_4501'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4501
IS_REQUIRED_CORE: Final[bool] = False
ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'quadratic_graph_vertex_axis_choice'
TARGET_TASK: Final[str] = 'quadratic_graph_vertex_axis_choice'
TEMPLATE_SLOT: Final[str] = 'quadratic_graph_vertex_axis_choice'
PROBLEM_TYPE_ID: Final[str] = 'integer_quadratic_graph_vertex_axis_choice'
