...
COMPONENT_ID: Final[str] = "src_11716"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_2_1_1"
SOURCE_REF: Final[str] = "src_11716"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11716
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_sin_from_side_and_circumradius"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_sin_from_side_and_circumradius"

TARGET_TASK: Final[str] = "compute_sin_from_side_and_circumradius"
TEMPLATE_SLOT: Final[str] = "compute_sin_from_side_and_circumradius"
PROBLEM_TYPE_ID: Final[str] = "compute_sin_from_side_and_circumradius"
...
DOMAIN_LIBRARY: Final[tuple[str, ...]] = (
    "core.domain.trigonometry_law_of_sines_domain.build_trigonometry_law_of_sines_matrix",
)
