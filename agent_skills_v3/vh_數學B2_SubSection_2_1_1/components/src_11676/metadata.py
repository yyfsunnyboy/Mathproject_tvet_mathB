...
COMPONENT_ID: Final[str] = "src_11676"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_2_1_1"
SOURCE_REF: Final[str] = "src_11676"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11676
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_triangle_area_sas"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_triangle_area_sas"

TARGET_TASK: Final[str] = "compute_triangle_area_sas"
TEMPLATE_SLOT: Final[str] = "compute_triangle_area_sas"
PROBLEM_TYPE_ID: Final[str] = "compute_triangle_area_sas"
