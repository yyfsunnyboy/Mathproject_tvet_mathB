...
COMPONENT_ID: Final[str] = "src_11945"
SKILL_ID: Final[str] = 'vh_數學B3_SubSection_1_2_2'
SOURCE_REF: Final[str] = "src_11945"
SOURCE_KIND: Final[str] = 'exercise'
TEXTBOOK_EXAMPLE_ID: Final[int] = 11945
IS_REQUIRED_CORE: Final[bool] = True

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'geometric_mean_solve_x'
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = 'geometric_mean_solve_x'

TARGET_TASK: Final[str] = 'geometric_mean_solve_x'
TEMPLATE_SLOT: Final[str] = 'geometric_mean_solve_x'
PROBLEM_TYPE_ID: Final[str] = 'geometric_mean_solve_x'
