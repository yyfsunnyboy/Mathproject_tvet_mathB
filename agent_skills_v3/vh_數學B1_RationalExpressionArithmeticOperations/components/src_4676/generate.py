...
TEXTBOOK_EXAMPLE_ID = 4676
DEFAULT_COMPONENT_ID = "src_4676" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '化簡下列各式：(1)$\\frac{{{x}^{2}}-1}{{{x}^{2}}+x-12}\\times \\frac{{{x}^{2}}-16}{{{x}^{2}}-3x-4}$ (2)$\\frac{{{x}^{2}}+x}{{{x}^{2}}-25}\\div \\frac{x+1}{x-5}$'
