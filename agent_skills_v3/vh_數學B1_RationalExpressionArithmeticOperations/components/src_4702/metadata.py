...
COMPONENT_ID: Final[str] = "src_4702"
SKILL_ID: Final[str] = "vh_數學B1_RationalExpressionArithmeticOperations"
SOURCE_REF: Final[str] = "src_4702"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4702
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "rational_expression_arithmetic"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "rational_expression_arithmetic"

TARGET_TASK: Final[str] = "rational_expression_arithmetic"
TEMPLATE_SLOT: Final[str] = "rational_expression_arithmetic"
PROBLEM_TYPE_ID: Final[str] = "rational_expression_arithmetic"
