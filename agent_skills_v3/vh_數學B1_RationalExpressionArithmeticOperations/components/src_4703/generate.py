...
TEXTBOOK_EXAMPLE_ID = 4703
DEFAULT_COMPONENT_ID = "src_4703" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '化簡$\\frac{{{x}^{2}}-2x-3}{{{x}^{2}}-1}\\div \\frac{x-3}{x-2}$。'
