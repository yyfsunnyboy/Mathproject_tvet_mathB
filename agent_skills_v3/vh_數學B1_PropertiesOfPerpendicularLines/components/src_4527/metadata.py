...
COMPONENT_ID: Final[str] = "src_4527"
SKILL_ID: Final[str] = "vh_數學B1_PropertiesOfPerpendicularLines"
SOURCE_REF: Final[str] = "src_4527"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4527
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "triangle_right_angle_verification"
ANSWER_SCHEMA_KEY: Final[str] = "numeric_scalar"
LINE_TYPE: Final[str] = "triangle_right_angle_verification"

TARGET_TASK: Final[str] = "triangle_right_angle_verification"
TEMPLATE_SLOT: Final[str] = "triangle_right_angle_verification"
PROBLEM_TYPE_ID: Final[str] = "triangle_right_angle_verification"
