...
COMPONENT_ID: Final[str] = "src_4531"
SKILL_ID: Final[str] = "vh_數學B1_PropertiesOfPerpendicularLines"
SOURCE_REF: Final[str] = "src_4531"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4531
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "perpendicular_segments_parameter"
ANSWER_SCHEMA_KEY: Final[str] = "parameter_scalar"
LINE_TYPE: Final[str] = "perpendicular_segments_parameter"

TARGET_TASK: Final[str] = "perpendicular_segments_parameter"
TEMPLATE_SLOT: Final[str] = "perpendicular_segments_parameter"
PROBLEM_TYPE_ID: Final[str] = "perpendicular_segments_parameter"
