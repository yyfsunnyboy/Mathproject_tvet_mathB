...
COMPONENT_ID: Final[str] = "src_11806"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_1"
SOURCE_REF: Final[str] = "src_11806"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11806
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "identify_equal_vector_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "identify_equal_vector_mcq"

TARGET_TASK: Final[str] = "identify_equal_vector_mcq"
TEMPLATE_SLOT: Final[str] = "identify_equal_vector_mcq"
PROBLEM_TYPE_ID: Final[str] = "identify_equal_vector_mcq"
