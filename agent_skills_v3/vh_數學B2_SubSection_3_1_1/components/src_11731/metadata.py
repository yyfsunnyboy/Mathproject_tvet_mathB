...
COMPONENT_ID: Final[str] = "src_11731"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_1"
SOURCE_REF: Final[str] = "src_11731"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11731
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "express_named_vectors_in_given_basis"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "express_named_vectors_in_given_basis"

TARGET_TASK: Final[str] = "express_named_vectors_in_given_basis"
TEMPLATE_SLOT: Final[str] = "express_named_vectors_in_given_basis"
PROBLEM_TYPE_ID: Final[str] = "express_named_vectors_in_given_basis"
