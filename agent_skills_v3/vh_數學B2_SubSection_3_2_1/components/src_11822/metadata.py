...
COMPONENT_ID: Final[str] = "src_11822"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_1"
SOURCE_REF: Final[str] = "src_11822"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11822
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_triangle_perimeter_from_two_vectors"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "compute_triangle_perimeter_from_two_vectors"

TARGET_TASK: Final[str] = "compute_triangle_perimeter_from_two_vectors"
TEMPLATE_SLOT: Final[str] = "compute_triangle_perimeter_from_two_vectors"
PROBLEM_TYPE_ID: Final[str] = "compute_triangle_perimeter_from_two_vectors"
