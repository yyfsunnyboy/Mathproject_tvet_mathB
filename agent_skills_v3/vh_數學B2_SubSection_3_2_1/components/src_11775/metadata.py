...
COMPONENT_ID: Final[str] = "src_11775"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_1"
SOURCE_REF: Final[str] = "src_11775"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11775
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_directed_segment_mixed_multipart"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_directed_segment_mixed_multipart"

TARGET_TASK: Final[str] = "compute_directed_segment_mixed_multipart"
TEMPLATE_SLOT: Final[str] = "compute_directed_segment_mixed_multipart"
PROBLEM_TYPE_ID: Final[str] = "compute_directed_segment_mixed_multipart"
