...
COMPONENT_ID: Final[str] = "src_11755"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_1"
SOURCE_REF: Final[str] = "src_11755"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11755
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_vector_components_and_magnitude"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_vector_components_and_magnitude"

TARGET_TASK: Final[str] = "compute_vector_components_and_magnitude"
TEMPLATE_SLOT: Final[str] = "compute_vector_components_and_magnitude"
PROBLEM_TYPE_ID: Final[str] = "compute_vector_components_and_magnitude"
