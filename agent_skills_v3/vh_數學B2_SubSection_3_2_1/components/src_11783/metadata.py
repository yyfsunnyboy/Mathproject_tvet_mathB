...
COMPONENT_ID: Final[str] = "src_11783"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_1"
SOURCE_REF: Final[str] = "src_11783"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11783
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_directed_segment_and_magnitude"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_directed_segment_and_magnitude"

TARGET_TASK: Final[str] = "compute_directed_segment_and_magnitude"
TEMPLATE_SLOT: Final[str] = "compute_directed_segment_and_magnitude"
PROBLEM_TYPE_ID: Final[str] = "compute_directed_segment_and_magnitude"
