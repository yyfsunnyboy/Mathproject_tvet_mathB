...
COMPONENT_ID: Final[str] = "src_11756"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_1"
SOURCE_REF: Final[str] = "src_11756"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11756
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_equal_vector_coordinates"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_equal_vector_coordinates"

TARGET_TASK: Final[str] = "solve_equal_vector_coordinates"
TEMPLATE_SLOT: Final[str] = "solve_equal_vector_coordinates"
PROBLEM_TYPE_ID: Final[str] = "solve_equal_vector_coordinates"
