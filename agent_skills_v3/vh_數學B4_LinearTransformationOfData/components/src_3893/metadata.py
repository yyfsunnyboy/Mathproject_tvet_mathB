...
COMPONENT_ID: Final[str] = "src_3893"
SKILL_ID: Final[str] = "vh_數學B4_LinearTransformationOfData"
SOURCE_REF: Final[str] = "src_3893"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3893
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_linear_transform_median_and_range"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_linear_transform_median_and_range"

TARGET_TASK: Final[str] = "compute_linear_transform_median_and_range"
TEMPLATE_SLOT: Final[str] = "compute_linear_transform_median_and_range"
PROBLEM_TYPE_ID: Final[str] = "compute_linear_transform_median_and_range"
