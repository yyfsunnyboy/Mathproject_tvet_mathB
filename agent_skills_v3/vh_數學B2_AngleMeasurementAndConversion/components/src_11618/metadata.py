...
COMPONENT_ID: Final[str] = "src_11618"
SKILL_ID: Final[str] = "vh_數學B2_AngleMeasurementAndConversion"
SOURCE_REF: Final[str] = "src_11618"
SOURCE_KIND: Final[str] = "textbook_exercise"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11618
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "convert_radian_to_degree"
ANSWER_SCHEMA_KEY: Final[str] = "multi_part"
LINE_TYPE: Final[str] = "angle_conversion"

TARGET_TASK: Final[str] = "convert_radian_to_degree_multi"
TEMPLATE_SLOT: Final[str] = "convert_radian_to_degree_multi"
