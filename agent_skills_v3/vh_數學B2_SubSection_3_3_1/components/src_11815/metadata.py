...
COMPONENT_ID: Final[str] = "src_11815"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_1"
SOURCE_REF: Final[str] = "src_11815"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11815
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "classify_angle_quality_from_dot_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "classify_angle_quality_from_dot_mcq"

TARGET_TASK: Final[str] = "classify_angle_quality_from_dot_mcq"
TEMPLATE_SLOT: Final[str] = "classify_angle_quality_from_dot_mcq"
PROBLEM_TYPE_ID: Final[str] = "classify_angle_quality_from_dot_mcq"
