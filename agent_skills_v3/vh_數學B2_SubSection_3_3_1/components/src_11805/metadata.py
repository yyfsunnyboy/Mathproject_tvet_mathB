...
COMPONENT_ID: Final[str] = "src_11805"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_1"
SOURCE_REF: Final[str] = "src_11805"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11805
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_navigation_heading_correction"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_navigation_heading_correction"

TARGET_TASK: Final[str] = "solve_navigation_heading_correction"
TEMPLATE_SLOT: Final[str] = "solve_navigation_heading_correction"
PROBLEM_TYPE_ID: Final[str] = "solve_navigation_heading_correction"
