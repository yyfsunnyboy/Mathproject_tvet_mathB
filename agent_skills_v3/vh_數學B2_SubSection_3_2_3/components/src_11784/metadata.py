...
COMPONENT_ID: Final[str] = "src_11784"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_3"
SOURCE_REF: Final[str] = "src_11784"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11784
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_point_from_vector_combination"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_point_from_vector_combination"

TARGET_TASK: Final[str] = "solve_point_from_vector_combination"
TEMPLATE_SLOT: Final[str] = "solve_point_from_vector_combination"
PROBLEM_TYPE_ID: Final[str] = "solve_point_from_vector_combination"
