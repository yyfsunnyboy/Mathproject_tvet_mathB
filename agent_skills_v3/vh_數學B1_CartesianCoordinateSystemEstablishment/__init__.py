...
GENERATOR_SPECS = [
    {
        'textbook_example_id': 4417,
        'component_id': 'src_4417',
        'generator_key': 'src_4417',
        'presentation_mode': 'single_choice',
        'response_mode': 'choice',
        'interaction_type': 'choice',
        'source_kind': 'example',
        'line_type': 'cartesian_coordinate_quadrant_symbol_reasoning',
        'answer_type': 'choice',
    ...
    },
    {
        ...
        'component_id': 'src_4435',
        'generator_key': 'src_4435',
        'presentation_mode': 'single_choice',
        'response_mode': 'choice',
        'interaction_type': 'choice',
        'source_kind': 'example',
    ...
    },
    {
        ...
        'component_id': 'src_4509',
        'generator_key': 'src_4509',
        'presentation_mode': 'single_choice',
        'response_mode': 'choice',
        'interaction_type': 'choice',
        'source_kind': 'example',
        'line_type': 'axis_distance_coordinate_point_numerical_choice',
        'answer_type': 'choice',
        'answer_value_type': 'choice_label',
    ...
    },
    {
        ...
        'component_id': 'src_4510',
        'generator_key': 'src_4510',
        'presentation_mode': 'single_choice',
        'response_mode': 'choice',
        'interaction_type': 'choice',
        'source_kind': 'example',
        'line_type': 'quadrant_statement_reasoning_choice',
        'answer_type': 'choice',
        'answer_value_type': 'choice_label',
...
_COMPONENT_DISPATCH = {
    'src_4417': 'components/src_4417/generate.py',
    'src_4435': 'components/src_4435/generate.py',
    'src_4509': 'components/src_4509/generate.py',
    'src_4510': 'components/src_4510/generate.py'
}
...
def _minimal_answer_contract(payload: dict[str, Any], spec: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "semantic_answer": payload.get("answer", ""),
    }
