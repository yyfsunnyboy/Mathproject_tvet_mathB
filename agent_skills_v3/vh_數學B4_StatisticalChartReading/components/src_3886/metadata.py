...
DOMAIN_OPERATION: Final[str] = "cumulative_below_interval_count"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "cumulative_below_interval_count"

TARGET_TASK: Final[str] = "cumulative_below_interval_count"
TEMPLATE_SLOT: Final[str] = "cumulative_below_interval_count"
PROBLEM_TYPE_ID: Final[str] = "cumulative_below_interval_count"
