...
COMPONENT_ID: Final[str] = "src_3885"
SKILL_ID: Final[str] = "vh_數學B4_StatisticalChartReading"
SOURCE_REF: Final[str] = "src_3885"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3885
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "cumulative_above_interval_count"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "cumulative_above_interval_count"

TARGET_TASK: Final[str] = "cumulative_above_interval_count"
TEMPLATE_SLOT: Final[str] = "cumulative_above_interval_count"
PROBLEM_TYPE_ID: Final[str] = "cumulative_above_interval_count"
