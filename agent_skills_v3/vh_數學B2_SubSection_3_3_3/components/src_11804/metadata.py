...
COMPONENT_ID: Final[str] = "src_11804"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_3"
SOURCE_REF: Final[str] = "src_11804"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11804
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "plot_navigation_points_coordinates"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "plot_navigation_points_coordinates"

TARGET_TASK: Final[str] = "plot_navigation_points_coordinates"
TEMPLATE_SLOT: Final[str] = "plot_navigation_points_coordinates"
PROBLEM_TYPE_ID: Final[str] = "plot_navigation_points_coordinates"
