...
COMPONENT_ID: Final[str] = "src_11789"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_3"
SOURCE_REF: Final[str] = "src_11789"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11789
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_cosine_of_angle_from_dot"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_cosine_of_angle_from_dot"

TARGET_TASK: Final[str] = "compute_cosine_of_angle_from_dot"
TEMPLATE_SLOT: Final[str] = "compute_cosine_of_angle_from_dot"
PROBLEM_TYPE_ID: Final[str] = "compute_cosine_of_angle_from_dot"
