...
COMPONENT_ID: Final[str] = "src_11812"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_3"
SOURCE_REF: Final[str] = "src_11812"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11812
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_midpoint_dot_product"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "compute_midpoint_dot_product"

TARGET_TASK: Final[str] = "compute_midpoint_dot_product"
TEMPLATE_SLOT: Final[str] = "compute_midpoint_dot_product"
PROBLEM_TYPE_ID: Final[str] = "compute_midpoint_dot_product"
