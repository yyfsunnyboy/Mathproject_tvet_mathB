...
COMPONENT_ID: Final[str] = "src_11813"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_3"
SOURCE_REF: Final[str] = "src_11813"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11813
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "solve_dot_product_parameter_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "solve_dot_product_parameter_mcq"

TARGET_TASK: Final[str] = "solve_dot_product_parameter_mcq"
TEMPLATE_SLOT: Final[str] = "solve_dot_product_parameter_mcq"
PROBLEM_TYPE_ID: Final[str] = "solve_dot_product_parameter_mcq"
