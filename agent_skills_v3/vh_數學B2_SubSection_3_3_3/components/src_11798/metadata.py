...
COMPONENT_ID: Final[str] = "src_11798"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_3"
SOURCE_REF: Final[str] = "src_11798"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11798
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_dot_product_coordinates"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_dot_product_coordinates"

TARGET_TASK: Final[str] = "compute_dot_product_coordinates"
TEMPLATE_SLOT: Final[str] = "compute_dot_product_coordinates"
PROBLEM_TYPE_ID: Final[str] = "compute_dot_product_coordinates"
