...
TEXTBOOK_EXAMPLE_ID = 4685
DEFAULT_COMPONENT_ID = "src_4685" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '若x為正整數，且$P=8{{x}^{2}}-50x-13$是質數，試求此質數。'
