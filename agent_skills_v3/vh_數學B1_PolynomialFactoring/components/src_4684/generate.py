...
TEXTBOOK_EXAMPLE_ID = 4684
DEFAULT_COMPONENT_ID = "src_4684" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{3}}+8$ (2)$125{{x}^{3}}-27$'
