...
TEXTBOOK_EXAMPLE_ID = 4673
DEFAULT_COMPONENT_ID = "src_4673" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{3}}-27$(2)${{x}^{4}}-256$(3)${{a}^{3}}+8{{b}^{3}}$'
