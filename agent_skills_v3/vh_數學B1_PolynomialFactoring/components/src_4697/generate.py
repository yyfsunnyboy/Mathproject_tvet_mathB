...
TEXTBOOK_EXAMPLE_ID = 4697
DEFAULT_COMPONENT_ID = "src_4697" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{3}}-1$ (2)$8{{x}^{3}}+125$'
