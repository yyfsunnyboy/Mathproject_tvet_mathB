...
TEXTBOOK_EXAMPLE_ID = 4683
DEFAULT_COMPONENT_ID = "src_4683" if TEXTBOOK_EXAMPLE_ID else ""

SOURCE_PROBLEM_TEXT = '利用乘法公式因式分解下列各式：(1)${{x}^{2}}+4x+4$ (2)$25{{x}^{2}}-20x+4$'
