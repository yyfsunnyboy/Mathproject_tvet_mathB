...
COMPONENT_ID: Final[str] = "src_4522"
SKILL_ID: Final[str] = "vh_數學B1_SlopeOfALine"
SOURCE_REF: Final[str] = "src_4522"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4522
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_parameter_from_known_slope"
ANSWER_SCHEMA_KEY: Final[str] = "parameter_scalar"
LINE_TYPE: Final[str] = "solve_parameter_from_known_slope"

TARGET_TASK: Final[str] = "solve_parameter_from_known_slope"
TEMPLATE_SLOT: Final[str] = "solve_parameter_from_known_slope"
PROBLEM_TYPE_ID: Final[str] = "solve_parameter_from_known_slope"
