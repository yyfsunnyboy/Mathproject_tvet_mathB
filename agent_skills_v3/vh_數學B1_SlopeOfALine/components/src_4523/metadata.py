...
COMPONENT_ID: Final[str] = "src_4523"
SKILL_ID: Final[str] = "vh_數學B1_SlopeOfALine"
SOURCE_REF: Final[str] = "src_4523"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4523
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "collinear_three_points_parameter"
ANSWER_SCHEMA_KEY: Final[str] = "parameter_scalar"
LINE_TYPE: Final[str] = "collinear_three_points_parameter"

TARGET_TASK: Final[str] = "collinear_three_points_parameter"
TEMPLATE_SLOT: Final[str] = "collinear_three_points_parameter"
PROBLEM_TYPE_ID: Final[str] = "collinear_three_points_parameter"
