...
COMPONENT_ID: Final[str] = "src_4533"
SKILL_ID: Final[str] = "vh_數學B1_SlopeOfALine"
SOURCE_REF: Final[str] = "src_4533"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4533
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "slopes_of_named_segments"
ANSWER_SCHEMA_KEY: Final[str] = "multi_part_scalar"
LINE_TYPE: Final[str] = "slopes_of_named_segments"

TARGET_TASK: Final[str] = "slopes_of_named_segments"
TEMPLATE_SLOT: Final[str] = "slopes_of_named_segments"
PROBLEM_TYPE_ID: Final[str] = "slopes_of_named_segments"
