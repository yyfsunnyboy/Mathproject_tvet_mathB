...
COMPONENT_ID: Final[str] = "src_4590"
SKILL_ID: Final[str] = "vh_數學B1_SlopeOfALine"
SOURCE_REF: Final[str] = "src_4590"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4590
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "solve_parameter_from_known_slope_choice"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "solve_parameter_from_known_slope_choice"

TARGET_TASK: Final[str] = "solve_parameter_from_known_slope_choice"
TEMPLATE_SLOT: Final[str] = "solve_parameter_from_known_slope_choice"
PROBLEM_TYPE_ID: Final[str] = "solve_parameter_from_known_slope_choice"
