...
COMPONENT_ID: Final[str] = "src_4521"
SKILL_ID: Final[str] = "vh_數學B1_SlopeOfALine"
SOURCE_REF: Final[str] = "src_4521"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4521
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "slope_from_two_points"
ANSWER_SCHEMA_KEY: Final[str] = "slope_intercept"
LINE_TYPE: Final[str] = "slope_from_two_points"

TARGET_TASK: Final[str] = "slope_from_two_points"
TEMPLATE_SLOT: Final[str] = "slope_from_two_points"
PROBLEM_TYPE_ID: Final[str] = "slope_from_two_points"
