...
COMPONENT_ID: Final[str] = "src_4601"
SKILL_ID: Final[str] = "vh_數學B1_SlopeOfALine"
SOURCE_REF: Final[str] = "src_4601"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4601
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "collinear_three_points_parameter_choice"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "collinear_three_points_parameter_choice"

TARGET_TASK: Final[str] = "collinear_three_points_parameter_choice"
TEMPLATE_SLOT: Final[str] = "collinear_three_points_parameter_choice"
PROBLEM_TYPE_ID: Final[str] = "collinear_three_points_parameter_choice"
