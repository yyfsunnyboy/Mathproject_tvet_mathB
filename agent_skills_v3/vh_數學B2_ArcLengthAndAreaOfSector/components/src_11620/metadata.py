...
COMPONENT_ID: Final[str] = "src_11620"
SKILL_ID: Final[str] = "vh_數學B2_ArcLengthAndAreaOfSector"
SOURCE_REF: Final[str] = "src_11620"
SOURCE_KIND: Final[str] = "exercise"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11620
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 18
DIFFICULTY_LEVEL: Final[str] = "medium"
DOMAIN_OPERATION: Final[str] = "calculate_pendulum_arc_and_area"
ANSWER_SCHEMA_KEY: Final[str] = "multi_part"
LINE_TYPE: Final[str] = "pendulum_arc_and_area"

TARGET_TASK: Final[str] = "calculate_pendulum_arc_and_area"
TEMPLATE_SLOT: Final[str] = "calculate_pendulum_arc_and_area"
...
MATH_OBJECTS: Final[tuple[str, ...]] = (
    "pendulum", "sector", "arc_length", "area", "angle",
)
