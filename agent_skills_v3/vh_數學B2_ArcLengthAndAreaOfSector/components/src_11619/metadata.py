...
COMPONENT_ID: Final[str] = "src_11619"
SKILL_ID: Final[str] = "vh_數學B2_ArcLengthAndAreaOfSector"
SOURCE_REF: Final[str] = "src_11619"
SOURCE_KIND: Final[str] = "exercise"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11619
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 17
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "calculate_arc_and_area"
ANSWER_SCHEMA_KEY: Final[str] = "multi_part"
LINE_TYPE: Final[str] = "sector_arc_and_area"

TARGET_TASK: Final[str] = "calculate_arc_and_area"
TEMPLATE_SLOT: Final[str] = "calculate_arc_and_area"
