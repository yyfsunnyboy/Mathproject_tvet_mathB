...
COMPONENT_ID: Final[str] = "src_11920"
SKILL_ID: Final[str] = 'vh_數學B3_SubSection_1_1_5'
SOURCE_REF: Final[str] = "src_11920"
SOURCE_KIND: Final[str] = 'exercise'
TEXTBOOK_EXAMPLE_ID: Final[int] = 11920
IS_REQUIRED_CORE: Final[bool] = True

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'arithmetic_series_from_two_terms'
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = 'arithmetic_series_from_two_terms'

TARGET_TASK: Final[str] = 'arithmetic_series_from_two_terms'
TEMPLATE_SLOT: Final[str] = 'arithmetic_series_from_two_terms'
PROBLEM_TYPE_ID: Final[str] = 'arithmetic_series_from_two_terms'
