...
PROBLEM_TYPE_ID = 'arithmetic_series_sum_given'
TEXTBOOK_EXAMPLE_ID = 11952
DEFAULT_COMPONENT_ID = "src_11952"
EXTRA_CONSTRAINTS = {'locked_stem': 'installment_equal_step_ap'}
