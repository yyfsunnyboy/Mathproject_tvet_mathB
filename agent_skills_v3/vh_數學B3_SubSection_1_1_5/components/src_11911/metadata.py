...
COMPONENT_ID: Final[str] = "src_11911"
SKILL_ID: Final[str] = 'vh_數學B3_SubSection_1_1_5'
SOURCE_REF: Final[str] = "src_11911"
SOURCE_KIND: Final[str] = 'quiz'
TEXTBOOK_EXAMPLE_ID: Final[int] = 11911
IS_REQUIRED_CORE: Final[bool] = True

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'arithmetic_series_recover_param'
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = 'arithmetic_series_recover_param'

TARGET_TASK: Final[str] = 'arithmetic_series_recover_param'
TEMPLATE_SLOT: Final[str] = 'arithmetic_series_recover_param'
PROBLEM_TYPE_ID: Final[str] = 'arithmetic_series_recover_param'
