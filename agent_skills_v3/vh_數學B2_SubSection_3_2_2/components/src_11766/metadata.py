...
COMPONENT_ID: Final[str] = "src_11766"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_2"
SOURCE_REF: Final[str] = "src_11766"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11766
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_triangle_chain_and_perimeter"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_triangle_chain_and_perimeter"

TARGET_TASK: Final[str] = "compute_triangle_chain_and_perimeter"
TEMPLATE_SLOT: Final[str] = "compute_triangle_chain_and_perimeter"
PROBLEM_TYPE_ID: Final[str] = "compute_triangle_chain_and_perimeter"
