...
TEXTBOOK_EXAMPLE_ID = 11766
DEFAULT_COMPONENT_ID = "src_11766" if TEXTBOOK_EXAMPLE_ID else ""
...
def generate(level: int = 1, seed: int | None = None, **kwargs: Any) -> dict[str, Any]:
    ...
    constraints = dict({'v3_induced_spec': {'classification_status': 'resolved', 'skill_id': 'vh_數學B2_SubSection_3_2_2', 'source_example_id': 11766, 'textbook_example_id': 11766, 'source_hash': 'dd524d3fdc7cbd246a23e1915a249355', 'problem_type_id': 'compute_triangle_chain_and_perimeter', 'required_capabilities': ['compute_triangle_chain_and_perimeter'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'phase1_classification': {'classification_status': 'resolved', 'skill_id': 'vh_數學B2_SubSection_3_2_2', 'source_example_id': 11766, 'textbook_example_id': 11766, 'source_hash': 'dd524d3fdc7cbd246a23e1915a249355', 'problem_type_id': 'compute_triangle_chain_and_perimeter', 'required_capabilities': ['compute_triangle_chain_and_perimeter'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'problem_type_id': 'compute_triangle_chain_and_perimeter', 'required_capabilities': ['compute_triangle_chain_and_perimeter'], 'classification_source': 'phase1_rule_pack', 'source_hash': 'dd524d3fdc7cbd246a23e1915a249355', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'source_example_id': 11766, 'answer_type': 'expression', 'exact_task_operation': '', 'domain_resolution': {'skill_id': 'vh_數學B2_SubSection_3_2_2', 'fixed_domain_key': 'vector.plane', 'resolution_source': 'confirmed_binding', 'binding_status': 'confirmed', 'required_capabilities': ['compute_triangle_chain_and_perimeter'], 'matched_capabilities': ['compute_triangle_chain_and_perimeter'], 'selected_operation': 'compute_triangle_chain_and_perimeter', 'registry_revision': '2026-09-10-v1.10', 'domain_module': 'core.domain.vector_plane_domain', 'entrypoint': 'build_vector_plane_matrix', 'allowed_operations': ['compute_vector_sum_difference', 'compute_point_vectors_linear_combination', 'compute_triangle_chain_and_perimeter', 'solve_parallelogram_fourth_vertex', 'compute_vector_linear_combination'], 'curriculum_profile': 'vocational_high_b'}, 'skill_id': 'vh_數學B2_SubSection_3_2_2'})
