...
COMPONENT_ID: Final[str] = "src_11780"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_2_2"
SOURCE_REF: Final[str] = "src_11780"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11780
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_vector_linear_combination"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_vector_linear_combination"

TARGET_TASK: Final[str] = "compute_vector_linear_combination"
TEMPLATE_SLOT: Final[str] = "compute_vector_linear_combination"
PROBLEM_TYPE_ID: Final[str] = "compute_vector_linear_combination"
