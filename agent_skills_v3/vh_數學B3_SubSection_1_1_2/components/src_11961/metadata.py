...
COMPONENT_ID: Final[str] = "src_11961"
SKILL_ID: Final[str] = 'vh_數學B3_SubSection_1_1_2'
SOURCE_REF: Final[str] = "src_11961"
SOURCE_KIND: Final[str] = 'test'
TEXTBOOK_EXAMPLE_ID: Final[int] = 11961
IS_REQUIRED_CORE: Final[bool] = True

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'arithmetic_nth_from_a1_d'
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = 'arithmetic_nth_from_a1_d'

TARGET_TASK: Final[str] = 'arithmetic_nth_from_a1_d'
TEMPLATE_SLOT: Final[str] = 'arithmetic_nth_from_a1_d'
PROBLEM_TYPE_ID: Final[str] = 'arithmetic_nth_from_a1_d'
