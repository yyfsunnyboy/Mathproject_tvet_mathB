...
COMPONENT_ID: Final[str] = "src_11852"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_1"
SOURCE_REF: Final[str] = "src_11852"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11852
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "classify_point_vs_circles_multipart"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "classify_point_vs_circles_multipart"

TARGET_TASK: Final[str] = "classify_point_vs_circles_multipart"
TEMPLATE_SLOT: Final[str] = "classify_point_vs_circles_multipart"
PROBLEM_TYPE_ID: Final[str] = "classify_point_vs_circles_multipart"
