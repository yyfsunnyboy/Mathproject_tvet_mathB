...
COMPONENT_ID: Final[str] = "src_11843"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11843"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11843
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "circle_equal_radius_at_origin"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "circle_equal_radius_at_origin"

TARGET_TASK: Final[str] = "circle_equal_radius_at_origin"
TEMPLATE_SLOT: Final[str] = "circle_equal_radius_at_origin"
PROBLEM_TYPE_ID: Final[str] = "circle_equal_radius_at_origin"
