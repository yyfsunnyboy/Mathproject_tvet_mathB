...
COMPONENT_ID: Final[str] = "src_11886"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11886"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11886
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "circle_origin_through_lines_intersection"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "circle_origin_through_lines_intersection"

TARGET_TASK: Final[str] = "circle_origin_through_lines_intersection"
TEMPLATE_SLOT: Final[str] = "circle_origin_through_lines_intersection"
PROBLEM_TYPE_ID: Final[str] = "circle_origin_through_lines_intersection"
