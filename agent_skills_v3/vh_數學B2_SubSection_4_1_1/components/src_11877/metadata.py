...
COMPONENT_ID: Final[str] = "src_11877"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11877"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11877
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "translate_and_scale_circle"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "translate_and_scale_circle"

TARGET_TASK: Final[str] = "translate_and_scale_circle"
TEMPLATE_SLOT: Final[str] = "translate_and_scale_circle"
PROBLEM_TYPE_ID: Final[str] = "translate_and_scale_circle"
