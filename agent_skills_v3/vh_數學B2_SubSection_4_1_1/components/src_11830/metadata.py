...
COMPONENT_ID: Final[str] = "src_11830"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11830"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11830
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "circle_from_diameter_endpoints"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "circle_from_diameter_endpoints"

TARGET_TASK: Final[str] = "circle_from_diameter_endpoints"
TEMPLATE_SLOT: Final[str] = "circle_from_diameter_endpoints"
PROBLEM_TYPE_ID: Final[str] = "circle_from_diameter_endpoints"
