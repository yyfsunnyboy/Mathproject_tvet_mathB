...
COMPONENT_ID: Final[str] = "src_11828"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11828"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11828
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "interpret_circular_locus_equation"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "interpret_circular_locus_equation"

TARGET_TASK: Final[str] = "interpret_circular_locus_equation"
TEMPLATE_SLOT: Final[str] = "interpret_circular_locus_equation"
PROBLEM_TYPE_ID: Final[str] = "interpret_circular_locus_equation"
