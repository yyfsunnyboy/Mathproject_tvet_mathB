...
COMPONENT_ID: Final[str] = "src_11827"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11827"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11827
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "identify_center_radius_from_standard"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "identify_center_radius_from_standard"

TARGET_TASK: Final[str] = "identify_center_radius_from_standard"
TEMPLATE_SLOT: Final[str] = "identify_center_radius_from_standard"
PROBLEM_TYPE_ID: Final[str] = "identify_center_radius_from_standard"
