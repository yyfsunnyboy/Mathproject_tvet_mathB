...
COMPONENT_ID: Final[str] = "src_11887"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_1_1"
SOURCE_REF: Final[str] = "src_11887"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11887
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "circle_same_center_scaled_area"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "circle_same_center_scaled_area"

TARGET_TASK: Final[str] = "circle_same_center_scaled_area"
TEMPLATE_SLOT: Final[str] = "circle_same_center_scaled_area"
PROBLEM_TYPE_ID: Final[str] = "circle_same_center_scaled_area"
