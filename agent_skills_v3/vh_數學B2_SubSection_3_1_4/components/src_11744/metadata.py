...
COMPONENT_ID: Final[str] = "src_11744"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_4"
SOURCE_REF: Final[str] = "src_11744"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11744
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "express_section_point_vector"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "express_section_point_vector"

TARGET_TASK: Final[str] = "express_section_point_vector"
TEMPLATE_SLOT: Final[str] = "express_section_point_vector"
PROBLEM_TYPE_ID: Final[str] = "express_section_point_vector"
