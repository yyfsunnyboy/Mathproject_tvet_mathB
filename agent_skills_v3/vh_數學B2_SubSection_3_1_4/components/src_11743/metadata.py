...
COMPONENT_ID: Final[str] = "src_11743"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_4"
SOURCE_REF: Final[str] = "src_11743"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11743
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "identify_resultant_path_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "identify_resultant_path_mcq"

TARGET_TASK: Final[str] = "identify_resultant_path_mcq"
TEMPLATE_SLOT: Final[str] = "identify_resultant_path_mcq"
PROBLEM_TYPE_ID: Final[str] = "identify_resultant_path_mcq"
