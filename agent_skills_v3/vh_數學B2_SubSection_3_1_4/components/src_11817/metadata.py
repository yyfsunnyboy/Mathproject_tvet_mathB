...
COMPONENT_ID: Final[str] = "src_11817"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_4"
SOURCE_REF: Final[str] = "src_11817"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11817
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "solve_section_coefficient_pair"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_section_coefficient_pair"

TARGET_TASK: Final[str] = "solve_section_coefficient_pair"
TEMPLATE_SLOT: Final[str] = "solve_section_coefficient_pair"
PROBLEM_TYPE_ID: Final[str] = "solve_section_coefficient_pair"
