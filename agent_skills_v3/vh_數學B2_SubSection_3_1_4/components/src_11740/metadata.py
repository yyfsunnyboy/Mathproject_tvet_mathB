...
COMPONENT_ID: Final[str] = "src_11740"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_4"
SOURCE_REF: Final[str] = "src_11740"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11740
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_scalar_multiple_relation_fill"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_scalar_multiple_relation_fill"

TARGET_TASK: Final[str] = "solve_scalar_multiple_relation_fill"
TEMPLATE_SLOT: Final[str] = "solve_scalar_multiple_relation_fill"
PROBLEM_TYPE_ID: Final[str] = "solve_scalar_multiple_relation_fill"
