...
COMPONENT_ID: Final[str] = "src_11818"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_4"
SOURCE_REF: Final[str] = "src_11818"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11818
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "express_linear_combination_from_givens"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "express_linear_combination_from_givens"

TARGET_TASK: Final[str] = "express_linear_combination_from_givens"
TEMPLATE_SLOT: Final[str] = "express_linear_combination_from_givens"
PROBLEM_TYPE_ID: Final[str] = "express_linear_combination_from_givens"
