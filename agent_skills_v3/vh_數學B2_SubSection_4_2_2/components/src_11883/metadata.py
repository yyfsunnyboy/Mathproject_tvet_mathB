...
COMPONENT_ID: Final[str] = "src_11883"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11883"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11883
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "solve_axis_tangent_parameter"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_axis_tangent_parameter"

TARGET_TASK: Final[str] = "solve_axis_tangent_parameter"
TEMPLATE_SLOT: Final[str] = "solve_axis_tangent_parameter"
PROBLEM_TYPE_ID: Final[str] = "solve_axis_tangent_parameter"
