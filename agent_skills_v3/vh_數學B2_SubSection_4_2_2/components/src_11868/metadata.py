...
COMPONENT_ID: Final[str] = "src_11868"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11868"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11868
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_line_circle_relation_ranges_multipart"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_line_circle_relation_ranges_multipart"

TARGET_TASK: Final[str] = "solve_line_circle_relation_ranges_multipart"
TEMPLATE_SLOT: Final[str] = "solve_line_circle_relation_ranges_multipart"
PROBLEM_TYPE_ID: Final[str] = "solve_line_circle_relation_ranges_multipart"
