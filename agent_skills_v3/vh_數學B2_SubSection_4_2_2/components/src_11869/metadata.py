...
COMPONENT_ID: Final[str] = "src_11869"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11869"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11869
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "count_line_circle_intersections"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "count_line_circle_intersections"

TARGET_TASK: Final[str] = "count_line_circle_intersections"
TEMPLATE_SLOT: Final[str] = "count_line_circle_intersections"
PROBLEM_TYPE_ID: Final[str] = "count_line_circle_intersections"
