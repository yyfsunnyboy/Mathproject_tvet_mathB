...
COMPONENT_ID: Final[str] = "src_11857"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11857"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11857
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_chord_length"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_chord_length"

TARGET_TASK: Final[str] = "compute_chord_length"
TEMPLATE_SLOT: Final[str] = "compute_chord_length"
PROBLEM_TYPE_ID: Final[str] = "compute_chord_length"
