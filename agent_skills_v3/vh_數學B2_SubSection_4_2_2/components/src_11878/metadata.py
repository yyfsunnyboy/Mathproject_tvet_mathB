...
COMPONENT_ID: Final[str] = "src_11878"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11878"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11878
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "classify_line_circle_relation_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "classify_line_circle_relation_mcq"

TARGET_TASK: Final[str] = "classify_line_circle_relation_mcq"
TEMPLATE_SLOT: Final[str] = "classify_line_circle_relation_mcq"
PROBLEM_TYPE_ID: Final[str] = "classify_line_circle_relation_mcq"
