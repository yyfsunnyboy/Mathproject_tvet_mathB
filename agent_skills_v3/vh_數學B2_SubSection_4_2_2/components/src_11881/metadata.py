...
COMPONENT_ID: Final[str] = "src_11881"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11881"
SOURCE_KIND: Final[str] = "test"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11881
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 30
DIFFICULTY_LEVEL: Final[str] = "hard"
DOMAIN_OPERATION: Final[str] = "compute_triangle_center_chord_area"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "compute_triangle_center_chord_area"

TARGET_TASK: Final[str] = "compute_triangle_center_chord_area"
TEMPLATE_SLOT: Final[str] = "compute_triangle_center_chord_area"
PROBLEM_TYPE_ID: Final[str] = "compute_triangle_center_chord_area"
