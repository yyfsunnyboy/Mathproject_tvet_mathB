...
ANSWER_TYPE = "choice"
PROBLEM_TYPE_ID = "compute_triangle_center_chord_area"
TEXTBOOK_EXAMPLE_ID = 11881
DEFAULT_COMPONENT_ID = "src_11881" if TEXTBOOK_EXAMPLE_ID else ""
