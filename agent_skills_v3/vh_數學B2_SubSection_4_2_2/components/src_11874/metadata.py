...
COMPONENT_ID: Final[str] = "src_11874"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11874"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11874
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_storm_path_length_in_circle"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_storm_path_length_in_circle"

TARGET_TASK: Final[str] = "compute_storm_path_length_in_circle"
TEMPLATE_SLOT: Final[str] = "compute_storm_path_length_in_circle"
PROBLEM_TYPE_ID: Final[str] = "compute_storm_path_length_in_circle"
