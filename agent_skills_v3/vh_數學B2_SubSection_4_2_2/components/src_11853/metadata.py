...
COMPONENT_ID: Final[str] = "src_11853"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_2"
SOURCE_REF: Final[str] = "src_11853"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11853
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "classify_line_circle_relation"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "classify_line_circle_relation"

TARGET_TASK: Final[str] = "classify_line_circle_relation"
TEMPLATE_SLOT: Final[str] = "classify_line_circle_relation"
PROBLEM_TYPE_ID: Final[str] = "classify_line_circle_relation"
