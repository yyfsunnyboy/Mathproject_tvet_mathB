...
COMPONENT_ID: Final[str] = "src_11865"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_4"
SOURCE_REF: Final[str] = "src_11865"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11865
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "count_line_vs_two_circles_intersections"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "count_line_vs_two_circles_intersections"

TARGET_TASK: Final[str] = "count_line_vs_two_circles_intersections"
TEMPLATE_SLOT: Final[str] = "count_line_vs_two_circles_intersections"
PROBLEM_TYPE_ID: Final[str] = "count_line_vs_two_circles_intersections"
