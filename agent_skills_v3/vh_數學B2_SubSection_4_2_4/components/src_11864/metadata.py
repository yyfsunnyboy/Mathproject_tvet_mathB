...
COMPONENT_ID: Final[str] = "src_11864"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_4_2_4"
SOURCE_REF: Final[str] = "src_11864"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11864
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_tangent_segment_lengths"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_tangent_segment_lengths"

TARGET_TASK: Final[str] = "compute_tangent_segment_lengths"
TEMPLATE_SLOT: Final[str] = "compute_tangent_segment_lengths"
PROBLEM_TYPE_ID: Final[str] = "compute_tangent_segment_lengths"
