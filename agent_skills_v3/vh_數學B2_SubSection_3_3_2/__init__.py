...
GENERATOR_KEYS = ['src_11797']
GENERATOR_SPECS = [{'textbook_example_id': 11797, 'component_id': 'src_11797', 'generator_key': 'src_11797', 'presentation_mode': 'short_answer', 'response_mode': 'short_answer', 'interaction_type': 'short_answer', 'source_kind': 'example', 'line_type': 'compute_dot_product_from_magnitudes_angle', 'answer_type': 'expression', 'answer_value_type': 'expression', 'problem_type_id': 'compute_dot_product_from_magnitudes_angle', 'checker_key': 'expression_checker', 'equivalence_type': None, 'display_order': 11797, 'source_order': 11797, 'sampling_weight': 10.0}]
_COMPONENT_DISPATCH = {'src_11797': 'components/src_11797/generate.py'}
