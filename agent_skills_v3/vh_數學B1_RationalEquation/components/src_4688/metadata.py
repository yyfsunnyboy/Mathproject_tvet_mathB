...
COMPONENT_ID: Final[str] = "src_4688"
SKILL_ID: Final[str] = "vh_數學B1_RationalEquation"
SOURCE_REF: Final[str] = "src_4688"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4688
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "rational_equation_solve"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "rational_equation_solve"

TARGET_TASK: Final[str] = "rational_equation_solve"
TEMPLATE_SLOT: Final[str] = "rational_equation_solve"
PROBLEM_TYPE_ID: Final[str] = "rational_equation_solve"
