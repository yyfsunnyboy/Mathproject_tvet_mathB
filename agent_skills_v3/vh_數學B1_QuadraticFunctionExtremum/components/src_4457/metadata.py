...
COMPONENT_ID: Final[str] = 'src_4457'
SKILL_ID: Final[str] = 'vh_數學B1_QuadraticFunctionExtremum'
SOURCE_REF: Final[str] = 'src_4457'
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 4457
IS_REQUIRED_CORE: Final[bool] = False
ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = 'compute_quadratic_vertex'
TARGET_TASK: Final[str] = 'compute_quadratic_vertex'
TEMPLATE_SLOT: Final[str] = 'compute_quadratic_vertex'
PROBLEM_TYPE_ID: Final[str] = 'integer_compute_quadratic_vertex'
