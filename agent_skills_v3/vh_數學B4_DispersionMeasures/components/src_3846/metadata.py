...
COMPONENT_ID: Final[str] = "src_3846"
SKILL_ID: Final[str] = "vh_數學B4_DispersionMeasures"
SOURCE_REF: Final[str] = "src_3846"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 3846
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compare_dispersion"
ANSWER_SCHEMA_KEY: Final[str] = "numeric_scalar"
LINE_TYPE: Final[str] = "compare_dispersion"

TARGET_TASK: Final[str] = "compare_dispersion"
TEMPLATE_SLOT: Final[str] = "compare_dispersion"
PROBLEM_TYPE_ID: Final[str] = "compare_dispersion"
