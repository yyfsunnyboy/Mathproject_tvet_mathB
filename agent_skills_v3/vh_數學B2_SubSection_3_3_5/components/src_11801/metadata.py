...
COMPONENT_ID: Final[str] = "src_11801"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_5"
SOURCE_REF: Final[str] = "src_11801"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11801
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "expand_perpendicular_dot_product"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "expand_perpendicular_dot_product"

TARGET_TASK: Final[str] = "expand_perpendicular_dot_product"
TEMPLATE_SLOT: Final[str] = "expand_perpendicular_dot_product"
PROBLEM_TYPE_ID: Final[str] = "expand_perpendicular_dot_product"
