...
COMPONENT_ID: Final[str] = "src_11794"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_5"
SOURCE_REF: Final[str] = "src_11794"
SOURCE_KIND: Final[str] = "quiz"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11794
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 20
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "compute_dot_product_from_magnitudes_angle"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "compute_dot_product_from_magnitudes_angle"

TARGET_TASK: Final[str] = "compute_dot_product_from_magnitudes_angle"
TEMPLATE_SLOT: Final[str] = "compute_dot_product_from_magnitudes_angle"
PROBLEM_TYPE_ID: Final[str] = "compute_dot_product_from_magnitudes_angle"
