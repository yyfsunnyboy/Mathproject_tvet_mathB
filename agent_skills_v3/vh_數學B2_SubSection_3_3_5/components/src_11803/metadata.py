...
COMPONENT_ID: Final[str] = "src_11803"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_5"
SOURCE_REF: Final[str] = "src_11803"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11803
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "solve_angle_from_magnitude_identity"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "solve_angle_from_magnitude_identity"

TARGET_TASK: Final[str] = "solve_angle_from_magnitude_identity"
TEMPLATE_SLOT: Final[str] = "solve_angle_from_magnitude_identity"
PROBLEM_TYPE_ID: Final[str] = "solve_angle_from_magnitude_identity"
