...
COMPONENT_ID: Final[str] = "src_11795"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_3_5"
SOURCE_REF: Final[str] = "src_11795"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11795
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "classify_dot_sign_from_diagram_mcq"
ANSWER_SCHEMA_KEY: Final[str] = "choice_label"
LINE_TYPE: Final[str] = "classify_dot_sign_from_diagram_mcq"

TARGET_TASK: Final[str] = "classify_dot_sign_from_diagram_mcq"
TEMPLATE_SLOT: Final[str] = "classify_dot_sign_from_diagram_mcq"
PROBLEM_TYPE_ID: Final[str] = "classify_dot_sign_from_diagram_mcq"
