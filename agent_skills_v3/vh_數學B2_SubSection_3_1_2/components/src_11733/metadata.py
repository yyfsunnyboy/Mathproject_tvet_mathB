...
COMPONENT_ID: Final[str] = "src_11733"
SKILL_ID: Final[str] = "vh_數學B2_SubSection_3_1_2"
SOURCE_REF: Final[str] = "src_11733"
SOURCE_KIND: Final[str] = "example"
TEXTBOOK_EXAMPLE_ID: Final[int] = 11733
IS_REQUIRED_CORE: Final[bool] = False

ORDER_WEIGHT: Final[int] = 10
DIFFICULTY_LEVEL: Final[str] = "easy"
DOMAIN_OPERATION: Final[str] = "simplify_vector_path_expression"
ANSWER_SCHEMA_KEY: Final[str] = ""
LINE_TYPE: Final[str] = "simplify_vector_path_expression"

TARGET_TASK: Final[str] = "simplify_vector_path_expression"
TEMPLATE_SLOT: Final[str] = "simplify_vector_path_expression"
PROBLEM_TYPE_ID: Final[str] = "simplify_vector_path_expression"
