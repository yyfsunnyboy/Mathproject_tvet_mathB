...
TEXTBOOK_EXAMPLE_ID = 11693
DEFAULT_COMPONENT_ID = "src_11693" if TEXTBOOK_EXAMPLE_ID else ""
...
def generate(level: int = 1, seed: int | None = None, **kwargs: Any) -> dict[str, Any]:
    ...
    constraints = dict({'v3_induced_spec': {'classification_status': 'resolved', 'skill_id': 'vh_數學B2_SubSection_2_2_4', 'source_example_id': 11693, 'textbook_example_id': 11693, 'source_hash': '9e513687dbc61d9b9ae0bc9b8e0b786d', 'problem_type_id': 'solve_side_by_law_of_cosines', 'required_capabilities': ['solve_side_by_law_of_cosines'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'phase1_classification': {'classification_status': 'resolved', 'skill_id': 'vh_數學B2_SubSection_2_2_4', 'source_example_id': 11693, 'textbook_example_id': 11693, 'source_hash': '9e513687dbc61d9b9ae0bc9b8e0b786d', 'problem_type_id': 'solve_side_by_law_of_cosines', 'required_capabilities': ['solve_side_by_law_of_cosines'], 'classification_source': 'phase1_rule_pack', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'answer_type': 'expression'}, 'problem_type_id': 'solve_side_by_law_of_cosines', 'required_capabilities': ['solve_side_by_law_of_cosines'], 'classification_source': 'phase1_rule_pack', 'source_hash': '9e513687dbc61d9b9ae0bc9b8e0b786d', 'presentation_mode': 'short_answer', 'answer_contract': {'answer_type': 'expression', 'checker_key': 'expression_checker', 'equivalence_type': 'algebraic_equivalent'}, 'source_example_id': 11693, 'answer_type': 'expression', 'exact_task_operation': '', 'domain_resolution': {'skill_id': 'vh_數學B2_SubSection_2_2_4', 'fixed_domain_key': 'trigonometry.oblique_triangle_measurement', 'resolution_source': 'confirmed_binding', 'binding_status': 'confirmed', 'required_capabilities': ['solve_side_by_law_of_cosines'], 'matched_capabilities': ['solve_side_by_law_of_cosines'], 'selected_operation': 'solve_side_by_law_of_cosines', 'registry_revision': '2026-09-10-v1.10', 'domain_module': 'core.domain.trigonometry_oblique_triangle_measurement_domain', 'entrypoint': 'build_trigonometry_oblique_triangle_measurement_matrix', 'allowed_operations': ['solve_side_by_law_of_sines', 'solve_side_by_law_of_cosines'], 'curriculum_profile': 'vocational_high_b'}, 'skill_id': 'vh_數學B2_SubSection_2_2_4'})
